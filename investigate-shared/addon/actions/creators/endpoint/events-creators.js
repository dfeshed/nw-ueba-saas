import fetchStreamingEvents from 'investigate-shared/actions/api/endpoint/events';
...
export const getEvents = () => {
  return (dispatch, getState) => {
    ...
    const { endTime, startTime, processName, serviceId, agentId } = state.investigateShared.endpoint.processTree.queryInput;
    ...
    fetchStreamingEvents(queryNode, streamLimit, streamBatch, handlers);
  };
};
