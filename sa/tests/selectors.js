...
export default Ember$.extend({}, BaseSelectors, {
  ...
  'pages': {
    ...
    'respond': {
      ...
      'card': {
        ...
        'incTile': {
          ...
          'assigneeDropDown': '.rsa-incident-tile-assignee-selector .rsa-icon-arrow-down-12-lined',
          'statusDropDown': '.rsa-incident-tile-status-selector .rsa-icon-arrow-down-12-lined',
          'priorityDropDown': '.rsa-incident-tile-priority-selector .rsa-icon-arrow-down-12-lined',
    ...
    'incident': {
      ...
      'categoryTagsDropdownIcon': '.rsa-content-accordion .rsa-icon-arrow-down-12-lined',
    ...
    'investigate': {
      ...
      'recon': {
        ...
        'reconHidePacket': '.recon-event-detail-packets .rsa-icon-arrow-down-12-lined',
