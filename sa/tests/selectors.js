...
export default Ember$.extend({}, BaseSelectors, {
  ...
  'pages': {
    ...
    'respond': {
      ...
      'card': {
        ...
        'incTile': {
          ...
          'sortSelect': '.sort-options__selection select',
          'sortLabel': '.sort-options__selection .prompt',
          'sortValue': '.sort-options__selection .prompt div',
          'sortSelectOption': '.sort-options__selection select option',
      ...
      'listView': {
        ...
        'assigneeColChkBox': '.column-selection-assigneeFirstLastName .inner-wrapper',
        ...
        'assigneeColInput': '.column-selection-assigneeFirstLastName input',
    ...
    'investigate': {
      ...
      'timeRangeDropDown': '.rsa-investigate-query-bar__time-range .rsa-form-button',
      'timeRangeSelectOptions': '.rsa-investigate-query-bar__time-range ul li',
