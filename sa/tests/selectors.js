...
export default {
  ...
  'pages': {
    ...
    'investigate': {
      ...
      'compresstimelineAnimationIcon': '.ember-view.rsa-icon.rsa-icon-shrink-horizontal-2.is-large',
      ...
      'expandtimelineAnimationIcon': '.ember-view.rsa-icon.rsa-icon-expand-vertical-4.is-large',
