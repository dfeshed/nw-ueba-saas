...
test('it renders', function(assert) {
  ...
  assert.equal(this.$('.indicator-wrapper:nth-child(1) .indicator-source div').length, 1, 'C2 Packet indicator has 1 source');
  ...
  assert.equal(this.$('.indicator-wrapper:nth-child(1) .indicator-source div').length, 1, 'C2 Log indicator has 1 source');
