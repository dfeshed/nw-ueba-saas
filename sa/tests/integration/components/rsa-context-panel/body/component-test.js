...
import DatasourceList from 'sa/context/im-columns';

moduleForComponent('rsa-context-panel/body', 'Integration | Component | rsa context panel/body', {
  integration: true
});
...
test('it renders', function(assert) {
  ...
  this.render(hbs`  {{rsa-context-panel/body contextData=alertsData   title=(t columns.title ) datasourceList=columns tabdata='overview'}}`);
