...
import originalService from 'investigate-events/services/redux';

export function applyPatch(initState) {
  unsee('investigate-events/services/redux');

  define('investigate-events/services/redux', ['exports', 'redux', 'ember-redux/services/redux', 'investigate-events/reducers/index', 'redux-thunk', 'redux-pack'], function(exports, _redux, _redux2, _index, _reduxThunk, _reduxPack) {
    'use strict';
...
export function revertPatch() {
  ...
  define('investigate-events/services/redux', ['exports'], function(exports) {
