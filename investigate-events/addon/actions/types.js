...
export const ADD_NEXT_GEN_PILL = 'INVESTIGATE_EVENTS::ADD_NEXT_GEN_PILL';
export const DELETE_NEXT_GEN_PILLS = 'INVESTIGATE_EVENTS::DELETE_NEXT_GEN_PILLS';
export const DESELECT_NEXT_GEN_PILLS = 'INVESTIGATE_EVENTS::DESELECT_NEXT_GEN_PILLS';
export const EDIT_NEXT_GEN_PILL = 'INVESTIGATE_EVENTS::EDIT_NEXT_GEN_PILL';
export const OPEN_NEXT_GEN_PILL_FOR_EDIT = 'INVESTIGATE_EVENTS::OPEN_NEXT_GEN_PILL_FOR_EDIT';
export const REPLACE_ALL_NEXT_GEN_PILLS = 'INVESTIGATE_EVENTS::REPLACE_ALL_NEXT_GEN_PILLS';
export const RESET_NEXT_GEN_PILL = 'INVESTIGATE_EVENTS::RESET_NEXT_GEN_PILL';
export const SELECT_NEXT_GEN_PILLS = 'INVESTIGATE_EVENTS::SELECT_NEXT_GEN_PILLS';
export const UPDATE_FREE_FORM_TEXT = 'INVESTIGATE_EVENTS::UPDATE_FREE_FORM_TEXT';
export const VALIDATE_NEXT_GEN_PILL = 'INVESTIGATE_EVENTS::VALIDATE_NEXT_GEN_PILL';
