...
import { COLUMN_GROUPS_LIST_LOCATION } from 'investigate-events/constants/columnGroups';
...
export default combineReducers({
  ...
  listManagers: combineReducers({
    columnGroups: createFilteredReducer(listManager, reducerPredicate(COLUMN_GROUPS_LIST_LOCATION))
  })
});
