...
import { setFilterText, setHighlightedIndex, resetFilterText } from 'rsa-list-manager/actions/creators/creators';
...
const ListFilter = Component.extend({
  ...
  actions: {
    ...
    resetFilter() {
      this.send('resetFilterText', this.get('stateLocation'));
    }
  }
});
