...
module('Integration | Component | item ', function(hooks) {
  ...
  test('Component for item renders when no selectedItem is passed, no OOTB indicators', async function(assert) {
    ...
    await render(hbs`{{list-manager/item-list/item item=item itemSelection=itemSelection hasOOTBIndicators=hasOOTBIndicators}}`);
  ...
  test('Component for item renders when selectedItem is clicked', async function(assert) {
    ...
    await render(hbs`{{list-manager/item-list/item item=item selectedItem=selectedItem itemSelection=itemSelection hasOOTBIndicators=hasOOTBIndicators}}`);
  ...
  test('Component for item renders correctly when item should be highlighted', async function(assert) {
    ...
    await render(hbs`{{list-manager/item-list/item item=item selectedItem=selectedItem
