...
module('Integration | Component | list filter', function(hooks) {
  ...
  test('Filters list with default filtering', async function(assert) {
    ...
    await render(hbs`{{list-manager/list-filter listName=listName originalList=originalList updateFilteredList=updateFilteredList}}`);
  ...
  test('clear filter resets the filter input and results', async function(assert) {
