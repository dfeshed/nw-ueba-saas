...
import CmsSearchRequest from 'live-content/utils/cms-search';
...
const fetchResults = (criteria) => {
  ...
  return basicPromiseRequest('findAll', 'live-search', '/rsa/cms/search/search', 'POST', cmsSearchRequest.toJSON());
};
