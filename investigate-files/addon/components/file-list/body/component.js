...
import { fetchMachineCount } from 'investigate-files/actions/data-creators';

const dispatchToActions = {
  fetchMachineCount
};
const FilesTableBody = DataTableBody.extend({
  insertCheckbox: true,
  ...
  _fetchMachineCount() {
    ...
    if (items.length) {
      this.send('fetchMachineCount', items);
    }
  }
});

export default connect(null, dispatchToActions)(FilesTableBody);
