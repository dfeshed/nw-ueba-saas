...
public class FailureFilePermissionEventGeneratorsBuilder extends FileUseCaseEventGeneratorsBuilder{
    ...
    public FailureFilePermissionEventGeneratorsBuilder(IUserGenerator normalUserGenerator,
    ...
    protected String getUseCaseTestName() {
        return "FailedFilePermissionEvent";
    }
