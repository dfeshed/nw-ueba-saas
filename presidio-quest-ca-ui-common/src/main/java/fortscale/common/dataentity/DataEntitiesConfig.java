    ...
    public DataEntity getLogicalEntity(String entityId) throws Exception{
        ...
        for(String fieldId: fieldIds){
            try {
                ...
                String[] jsonPathField = fieldConfig.getJsonPath();
                if (jsonPathField == null){
                    String jsonPath = getExtendableValue(entityId, "field", fieldId, "json_path");

                    if (StringUtils.isNotBlank(jsonPath)){
                            jsonPathField=jsonPath.split("/");

                    } else {
                        jsonPathField=new String[0];
                    }
                    fieldConfig.setJsonPath(jsonPathField);
                }
                field.setJsonPath(jsonPathField);
...
//     * @throws Exception
//     */
//    public PartitionStrategy getEntityPartitionStrategy(String entityId) throws Exception{
//        DataEntityConfig entityConfig = getEntityFromCache(entityId);
...
//    }
     ...
     * @throws Exception
     */
    public List<String> getEntityPartitionBaseField(String entityId) throws Exception{
        DataEntityConfig entityConfig = getEntityFromCache(entityId);
     ...
     * @return
     */
    public String getFieldColumn(String entityId, String fieldId) throws Exception {
        ...
        if (column == null)
            throw new Exception(String.format("Column for field %s in entity %s not found.", fieldId, entityId));

        fieldConfig.setColumn(column);
        return column;
    }

    public Boolean getFieldIsLogicalOnly(String entityId, String fieldId) throws Exception{
        return getFieldFlag(DataEntityFieldConfig.IS_LOGICAL_ONLY, entityId, fieldId);
    }

    public Boolean getFieldIsTokenized(String entityId, String fieldId) throws Exception{
        return getFieldFlag(DataEntityFieldConfig.IS_TOKENIZED, entityId, fieldId);
    }

    public Boolean getFieldIsExplicit(String entityId, String fieldId) throws Exception{
	 ...
	 * @throws Exception
	 */
	public String getFieldTable(String entityId, String fieldId) throws Exception{
    ...
    private Boolean getFieldFlag(String flagName, String entityId, String fieldId) throws Exception{
        DataEntityFieldConfig fieldConfig = getFieldFromCache(entityId, fieldId);
     ...
     * @throws Exception
     */
    public QueryValueType getFieldType(String entityId, String fieldId, Boolean ignoreUnknownType) throws Exception{
        DataEntityFieldConfig fieldConfig = getFieldFromCache(entityId, fieldId);
        ...
        if (typeStr == null) {
            ...
            throw new Exception(String.format("Couldn't find type for field %s in entity %s.", fieldId, entityId));
        }
    ...
    public QueryValueType getFieldType(String entityId, String fieldId) throws Exception{
