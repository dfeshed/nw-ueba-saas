...
inputPreProcessorDagFactory = InputPreProcessorDagFactory()
input_pre_processor_dag = inputPreProcessorDagFactory.create_and_register_dags(conf_key=InputPreProcessorDagFactory.input_pre_processor_conf_key, name_space=name_space, config_reader=config_reader)
...
retentionDagFactory.build_dags(retention_dag)
inputPreProcessorDagFactory.build_dags(input_pre_processor_dag)
