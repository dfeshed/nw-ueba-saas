...
moduleForComponent('respond/incident-rule/rule-builder/condition-group', 'Integration | Component | Respond Rule Builder Condition Group', {
  integration: true,
...
test('The component appears in the DOM', function(assert) {
  ...
  this.render(hbs`{{respond/incident-rule/rule-builder/condition-group info=groupInfo}}`);
...
test('The root group has no remove button', function(assert) {
  ...
  this.render(hbs`{{respond/incident-rule/rule-builder/condition-group info=groupInfo isRootGroup=true}}`);
