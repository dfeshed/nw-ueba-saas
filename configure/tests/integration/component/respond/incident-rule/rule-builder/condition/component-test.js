...
moduleForComponent('respond/incident-rule/rule-builder/condition', 'Integration | Component | Respond Rule Builder Condition', {
  integration: true,
...
test('The component appears in the DOM', function(assert) {
  ...
  this.render(hbs`{{respond/incident-rule/rule-builder/condition}}`);
