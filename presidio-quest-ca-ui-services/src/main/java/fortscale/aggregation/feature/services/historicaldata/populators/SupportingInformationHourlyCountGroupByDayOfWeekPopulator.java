...
public class SupportingInformationHourlyCountGroupByDayOfWeekPopulator extends SupportingInformationHistogramBySingleEventsPopulator {
    ...
    protected Map<SupportingInformationKey, Double> createSupportingInformationHistogram(String contextValue, long evidenceEndTime, Integer timePeriodInDays,Evidence evidence) {
        List featureBuckets = fetchRelevantFeatureBuckets(contextValue, evidenceEndTime, timePeriodInDays);
     ...
     */
    protected Map<SupportingInformationKey, Double> createSupportingInformationHistogram(List featureBuckets,
