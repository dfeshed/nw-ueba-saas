...
import DatasourceList from 'context/config/datasource-list';
...
test('it renders', function(assert) {
  ...
  this.render(hbs`  {{context-panel/data-table data=incidents title=(t columns.title ) modulesColumnListConfig=columns.columns headerdata=columns.header footerdata=columns.footer}}`);
