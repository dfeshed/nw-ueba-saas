...
moduleForComponent('context-panel/lc-identity', 'Integration | Component | context panel/lc identity', {
  integration: true
});
...
test('it renders', function(assert) {
  ...
  this.render(hbs`{{context-panel/live-connect/lc-identity liveConnectData=liveConnectData}}`);
