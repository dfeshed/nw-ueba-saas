...
describe('broccoli-theme', function() {
  var DARK = path.join('fixtures', 'assets', 'dark.css');
  var LIGHT = path.join('fixtures', 'assets', 'light.css');
  var DARK_PROD = path.join('fixtures', 'prod', 'dark-cfd46dd672a31535e0e47662f6dcb59f.css');
  var LIGHT_PROD = path.join('fixtures', 'prod', 'light-cfd46dd672a31535e0e47662f6dcb59f.css');

  afterEach(function() {
    fs.removeSync(DARK);
    fs.removeSync(LIGHT);
    fs.removeSync(DARK_PROD);
    fs.removeSync(LIGHT_PROD);
  });
