...
import originalService from 'admin/services/redux';

const { unsee } = require;

export function applyPatch(initState) {
  unsee('admin/services/redux');

  define('admin/services/redux', ['exports', 'redux', 'ember-redux/services/redux', 'admin/reducers/index', 'redux-thunk', 'redux-pack'], function(exports, _redux, _redux2, _index, _reduxThunk, _reduxPack) {
    'use strict';
...
export function revertPatch() {
  ...
  define('admin/services/redux', ['exports'], function(exports) {
