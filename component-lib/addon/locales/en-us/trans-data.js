export default {
  ...
  queryBuilder: {
    ...
    sessionid: 'Indexed properly (cannot be configured)',
    ...
    valueSuggestionsNoMatch: 'No suggestions found',
  ...
  investigate: {
    ...
    sortTooltips: {
      ...
      notSingleton: 'This column is not sortable because the meta key has multiple unindexed values.',
    ...
    maxQueryMemoryError: 'To avoid this error, try limiting the query by narrowing the time range, adding filters, removing complex filter operations, decreasing the number of columns in the column group, or ask an administrator to limit the number of events returned.',
    title: 'Investigate',
    loading: 'Loading',
    ...
    textSearchLimitedResults: '{{message}} Results may be limited by a text filter, which matches only indexed meta keys. To conduct a more exhaustive search against the raw events, click <a href="{{url}}" target="_blank">here</a> and choose the appropriate options in the Search Events drop-down menu.',
    ...
    events: {
      ...
      eventTips: {
        ...
        head: {
          ...
          summaryOne: 'This mode includes interactive auto-suggestions, optimization of keyboard entry, expansion of pasted text, a recent query list, and validation per filter.',
          textOne: {
        ...
        section: {
          mouse: {
            ...
            textTwo: 'Click one or more filters, or a parenthesis, and right-click to open the Actions menu.',
            ...
            textSix: 'Click the operator to switch between <span class="highlight">AND</span> / <span class="highlight">OR</span> operators.'
          ...
          keyboard: {
            ...
            textThree: 'Press <span class="highlight">Enter</span> or click the submit query button (magnifying glass) to execute a query.',
            ...
            textFive: 'Press <span class="highlight">Shift + left</span> or <span class="highlight">right arrow</span> to select multiple filters, then press <span class="highlight">Backspace</span> or <span class="highlight">Delete</span> to delete.',
            textSix: 'Press <span class="highlight">Tab</span> to switch between the Meta tab and Recent Queries tab in the drop-down menu.',
            textSeven: 'Press <span class="highlight">Home</span> and <span class="highlight">End</span> to jump to the beginning and end of the query.'
    ...
    queryStats: {
      error: 'Error',
      isMixedMode: 'For accurate service status details, all services queried must be on Version 11.3 or later.',
  ...
  preferences: {
    'investigate-events': {
      ...
      eventTimeSortOrder: 'Default Event Sort Order',
      'eventTimeSortOrder-tooltip': 'By default, sort events in ascending or descending order based on collection time. If results exceed the events limit, not all events can be loaded. The oldest events show if in ascending order and the newest events show if in descending order.',
  ...
  investigateHosts: {
    ...
    networkIsolation: {
      ...
      isolate: {
        ...
        checkboxLabel: 'Add IP addresses to the Exclusion List',
        checkboxDescription: 'Default IP addresses excluded from isolation include Endpoint Server, Relay Server, DNS, DHCP, Gateways, 0.0.0.0 and 255.255.255.255.',
        exclusionListPlaceholder: 'Enter one or more valid IPv4 and IPv6 addresses. Use commas to separate multiple values.',
    ...
    detailsColumns: {
      ...
      hookedProcess: 'Hooked Process',
      hookedFileName: 'Hooked File Name',
      hookedSymbol: 'Hooked Symbol',
      objectFunction: 'Object Function',
      hive: 'Hive',
      reason: 'Reason',
    ...
    endpoint: {
      ...
      fileAnalysis: {
        ...
        pe: {
          ...
          sectionNames: 'Section Names',
          sectionNamesAccordion: 'Section Names {{count}}',
          subSystem: 'Subsystem',
  ...
  adminUsm: {
    ...
    policies: {
      ...
      detail: {
        ...
        windowsLogSettings: 'Connection Settings',
        channelFilterSettings: 'Channel Filter Settings',
        windowsLogPolicyEnabled: 'Collect Windows Logs',
...
effects the simulated source.',
    ...
    policyWizard: {
      ...
      actionMessages: {
        ...
        saveNoGlobalSourceFailure: 'This policy is invalid. Please configure either ‘Connection Settings’ or ‘File Policy Settings’ in order to Save this policy',
        savePublishNoGlobalSourceFailure: 'This policy is invalid. Please configure either ‘Connection Settings’ or ‘File Policy Settings’ in order to Publish this policy',
      ...
      edrPolicy: {
        ...
        isolationEnabled: 'Network Isolation',
        isolationEnabledTooltip: 'Network Isolation blocks the host from connecting to the network. All attempted network connections are monitored and reported to the Endpoint Server.',
        isolationEnabledNote: 'Restores network connection of any isolated host.',
        ...
        fileSizeLimitTooltip: 'Limits the download of files based on the file size.',
        ...
        maxFileDownloadSizeInvalidMsg: 'File size should be between 1 KB - 10 MB',
        ...
        maxFileDownloadSize_KB: 'KB',
        maxFileDownloadSize_MB: 'MB',
        ...
        rarPolicyServer: 'Server',
        rarPolicyPort: 'Port',
        rarPolicyBeaconInterval: 'HTTP Beacon Interval',
        rarPolicy: {
          server: 'Server',
          port: 'Port',
      ...
      windowsLogPolicy: {
        ...
        protocol: 'Protocol',
        protocolTooltip: 'Select whether TLS, TCP, or UDP transport protocol is used to forward the collected windows logs to the NetWitness Platform servers. TLS is recommended but note that is is the heaviest option. TCP is reliable but unprotected, which may be acceptable within a corporate network. Finally, UDP is unsecured and delivery is not guaranteed.',
      ...
      filePolicy: {
        ...
        primaryDestination: 'Primary Log Decoder / Log Collector',
        primaryDestinationTooltip: 'The primary Log Decoder or Log Collector to which the collected logs will be forwarded.',
        secondaryDestination: 'Secondary Log Decoder / Log Collector',
        secondaryDestinationTooltip: 'If the primary Log Decoder or Log Collector is not reachable, collected logs will be forwarded to the secondary Log Decoder or Log Collector. NetWitness cannot detect failures when UDP is the protocol used.',
        fileDestinationDisabledTooltip: 'This Log Decoder / Log Collector needs to be on version 11.4 or above to receive file logs from the agent.',
        fileDestinationInvalidMsg: 'The log server host name should not be empty',
        protocol: 'Protocol',
        protocolTooltip: 'Select whether TLS, TCP, or UDP transport protocol is used to forward the collected logs to the NetWitness Platform servers. TLS is recommended but note that it is a resource intensive option. TCP is reliable but unsecure, which may be acceptable within a corporate network. Finally, UDP is unsecure and delivery is not guaranteed.',
        advancedConfig: 'Advanced Configuration',
        customConfig: 'Advanced Setting',
        customConfigTooltip: 'It is strongly recommended not to use this setting unless advised to by RSA support staff.',
        customConfigInvalidMsg: 'The custom setting cannot be empty or greater than 4000 characters',
        ...
        exclusionFiltersPlaceholder: 'Enter a regex pattern matching logs to be filtered out. Each new filter (regex pattern) must be separated by a new line. Maximum 16 filters can be entered.',
        paths: 'Paths',
        ...
        eventSourceError: 'One or more typespec files are removed from NetWitness Server.\n\
        If this was not intended, consider replacing the typespec file that was removed from the server for the affected File Type and restart the service.\n\
        If this was intended, remove the affected File Type configuration from this policy to make it valid.',
        fileSourceType: {
    ...
    policyTypes: {
      ...
      filePolicyDisabledTooltip: 'Endpoint servers need to be on version 11.4 or above to configure log file collection.',
  ...
  investigateUsers: {
    ...
    sortOptions: {
      ...
      score: 'Risk Score',
      alertsCount: 'Alerts',
      DAILY_TRENDS: 'Trending Last 24 Hours',
      WEEKLY_TRENDS: 'Trending Last 7 Days'
    },
    entityTypes: {
      all: 'All Entities',
      network: 'Network',
    ...
    errorMessages: {
      ...
      unableToGetAdminUserCount: 'Unable to get admin entities count.',
      unableToGetTotalUserCount: 'Unable to get toal entities count.',
      unableToGetRiskyUserCount: 'Unable to get risky entities count.',
      unableToGetWatchedUserCount: 'Unable to get watched entities count.',
      ...
      unableToFollowUsers: 'Unable to follow entities',
      unableToDeleteFavorite: 'Unable to delete saved filter.',
      topUsersError: 'Unable to fetch top risky entities.',
      usersError: 'Unable to fectch entities.',
      noUserData: 'No user data present.',
      unableToFindUsers: 'Unable to find entities'
    },
    users: {
      title: 'Users',
    ...
    alerts: {
      ...
      indicator: {
        title: 'Indicator',
        anomalyTypeFieldName: 'Indicator Name',
        ...
        indicatorNames: {
          ...
          abnormal_process_modified_registry_key_group: {
            ...
            timeline: '{{processFileName}} has modified a registry key from group {{registryKeyGroup}}',
          ...
          abnormal_process_executed_a_scripting_tool: {
            ...
            timeline: '{{anomalyValue}} has executed {{dstProcessFileName}}',
          ...
          abnormal_process_injects_into_windows_process: {
            ...
            timeline: '{{dstProcessFileName}} has created a remote thread in {{srcProcessFileNam}} process',
          ...
          uncommon_process_injects_into_windows_process: {
            ...
            timeline: '{{anomalyValue}} has created a remote thread in {{dstProcessFileName}}',
          ...
          abnormal_application_triggered_by_scripting_tool: {
            ...
            timeline: '{{srcProcessFileName}} has triggered {{anomalyValue}}',
          ...
          abnormal_process_opened_by_scripting_tool: {
            ...
            timeline: '{{srcProcessFileName}} has opened {{anomalyValue}}',
          ...
          high_number_of_reconnaissance_tools_executed_process: {
            ...
            timeline: '{{entityName}} has executed {{dstProcessFileName}} {{anomalyValue}} times in this hour',
          ...
          user_abnormal_application_triggered_by_scripting_tool: {
            ...
            timeline: '{{entityName}} has run {{srcProcessFileName}} to trigger {{anomalyValue}}',
          ...
          user_abnormal_process_opened_by_scripting_tool: {
            ...
            timeline: '{{entityName}} has run {{srcProcessFileName}} to open {{anomalyValue}}',
          ...
          user_abnormal_process_executed_a_scripting_tool: {
            ...
            timeline: '{{entityName}} has run {{anomalyValue}} to execute {{dstProcessFileName}}',
          ...
          high_number_of_bytes_sent_by_src_ip_to_ssl_subject_outbound: {
            ...
            desc: 'Abnormal number of bytes sent from {{srcIp}} to {{sslSubjectName}}',
            timeline: 'Abnormal number of bytes sent from{{srcIp}} to {{sslSubjectName}}',
          ...
          high_number_of_bytes_sent_by_src_ip_to_domain_ssl_subject_outbound: {
            ...
            desc: 'Abnormal number of bytes sent from {{srcIp}} to {{domainName}}',
            timeline: 'Abnormal number of bytes sent from {{srcIp}} to {{domainName}}',
          ...
          high_number_of_bytes_sent_by_src_ip_to_dst_org_ssl_subject_outbound: {
            ...
            desc: 'Abnormal number of bytes sent from {{srcIp}} to {{dstOrgName}}',
            timeline: 'Abnormal number of bytes sent from{{srcIp}} to {{dstOrgName}}',
          ...
          high_number_of_bytes_sent_by_src_ip_to_dst_port_ssl_subject_outbound: {
            ...
            desc: 'Abnormal number of bytes sent from {{srcIp}} to {{dstPortName}}',
            timeline: 'Abnormal number of bytes sent from {{srcIp}} to {{dstPortName}}',
          ...
          high_number_of_bytes_sent_to_ssl_subject_outbound: {
            ...
            desc: 'Abnormal number of bytes sent to {{sslSubjectName}}',
            timeline: 'Abnormal number of bytes sent to {{sslSubjectName}}',
          ...
          high_number_of_bytes_sent_to_domain_ssl_subject_outbound: {
            ...
            desc: 'Abnormal number of bytes sent to {{domainName}}',
            timeline: 'Abnormal number of bytes sent to {{domainName}}',
          ...
          high_number_of_bytes_sent_to_dst_port_ssl_subject_outbound: {
            ...
            desc: 'Abnormal number of bytes sent to {{dstPortName}}',
            timeline: 'Abnormal number of bytes sent to {{dstPortName}}',
          ...
          high_number_of_bytes_sent_to_dst_org_ssl_subject_outbound: {
            ...
            desc: 'Abnormal number of bytes sent to {{dstOrgName}}',
            timeline: 'Abnormal number of bytes sent to {{dstOrgName}}',
          ...
          high_number_of_bytes_sent_by_ja3_outbound: {
            ...
            desc: 'Abnormal number of bytes sent from {{ja3Name}}',
            timeline: 'Abnormal number of bytes sent from {{ja3Name}}',
            chartTitle: 'Bytes Sent Baseline (Last 30 Days)',
            axisYtitle: 'Number of Bytes'
          },
          high_number_of_distinct_src_ip_for_ja3_outbound: {
            name: 'High Number of IPs Use JA3',
            desc: 'High number of IPs use {{dstOrgName}}',
            timeline: 'High number of IPs use {{dstOrgName}}',
          ...
          abnormal_ssl_subject_for_src_netname_outbound: {
            ...
            desc: '{{sslSubjectName}} was accessed by {{srcNetname}}',
            timeline: '{{sslSubjectName}} was accessed by {{srcNetname}}',
          ...
          ssl_subject_abnormal_domain_for_src_netname_outbound: {
            ...
            desc: '{{domainName}} was accessed by {{srcNetname}}',
            timeline: '{{domainName}} was accessed by {{srcNetname}}',
          ...
          ssl_subject_abnormal_dst_port_for_src_netname_outbound: {
            ...
            desc: '{{dstPortName}} was accessed by {{srcNetname}}',
            timeline: '{{dstPortName}} was accessed by {{srcNetname}}',
          ...
          ssl_subject_abnormal_dst_org_for_src_netname_outbound: {
            ...
            desc: '{{dstOrgName}} was accessed by {{srcNetname}}',
            timeline: '{{dstOrgName}} was accessed by {{srcNetname}}',
          ...
          ssl_subject_abnormal_country_for_ssl_subject_outbound: {
            ...
            desc: 'Abnormal country for {{sslSubjectName}}',
            timeline: 'Abnormal country for {{sslSubjectName}}',
          ...
          ssl_subject_abnormal_dst_port_for_ssl_subject_outbound: {
            ...
            desc: '{{sslSubjectName}} was contacted through {{dstPortName}}',
            timeline: '{{sslSubjectName}} was contacted through {{dstPortName}}',
            chartTitle: 'Abnormal Destination Port',
            axisYtitle: 'Abnormal Destination Port'
          },
          ...
          ssl_subject_abnormal_ssl_subject_day_time: {
            ...
            desc: '{{sslSubjectName}} was contacted at an abnormal time',
            timeline: '{{sslSubjectName}} was contacted at an abnormal time',
          ...
          ssl_subject_abnormal_dst_port_for_domain_outbound: {
            ...
            desc: '{{domainName}} was contacted through {{dstPortName}}',
            timeline: '{{domainName}} was contacted through {{dstPortName}}',
            chartTitle: 'Abnormal Destination Port',
            axisYtitle: 'Abnormal Destination Port'
          },
          ...
          ssl_subject_abnormal_dst_port_for_dst_org_outbound: {
            ...
            desc: '{{dstOrgName}} was contacted through {{dstPortName}}',
            timeline: '{{dstOrgName}} was contacted through {{dstPortName}}',
            chartTitle: 'Abnormal Port',
            axisYtitle: 'Abnormal Port'
          },
          ...
          ssl_subject_abnormal_ja3_day_time: {
            ...
            desc: '{{ja3Name}} was used at an abnormal time',
            timeline: '{{ja3Name}} was used at an abnormal time',
          ...
          ssl_subject_abnormal_ja3_for_source_netname_outbound: {
            ...
            desc: '{{ja3Name}} was used by {{srcNetname}}',
            timeline: '{{ja3Name}} was used by {{srcNetname}}',
            chartTitle: 'Abnormal JA3',
            axisYtitle: 'Abnormal JA3'
          },
          ...
          ssl_subject_abnormal_ssl_subject_for_ja3_outbound: {
            ...
            desc: '{{sslSubjectName}} was contacted by {{ja3Name}}',
            timeline: '{{sslSubjectName}} was contacted by {{ja3Name}}',
            chartTitle: 'Abnormal SSL Subject',
            axisYtitle: 'Abnormal SSL Subject'
          },
          ...
          ssl_subject_abnormal_domain_for_ja3_outbound: {
            ...
            desc: '{{domainName}} was contacted by {{ja3Name}}',
            timeline: '{{domainName}} was contacted by {{ja3Name}}',
            chartTitle: 'Abnormal Domain',
          ...
          ssl_subject_abnormal_dst_port_for_ja3_outbound: {
            ...
            desc: '{{dstPortName}} was contacted by {{ja3Name}}',
            timeline: '{{dstPortName}} was contacted by {{ja3Name}}',
            chartTitle: 'Abnormal Destination Port',
            axisYtitle: 'Abnormal Destination Port'
          },
  ...
  dataFilters: {
    ...
    reset: 'Reset',
    timeframeOptions: {
      LAST_FIVE_MINUTES: 'More than 5 Minutes ago',
      LAST_TEN_MINUTES: 'More than 10 Minutes ago',
      LAST_FIFTEEN_MINUTES: 'More than 15 Minutes ago',
      LAST_THIRTY_MINUTES: 'More than 30 Minutes ago',
      LAST_ONE_HOUR: 'More than 1 Hour ago',
      LAST_THREE_HOURS: 'More than 3 Hours ago',
      LAST_SIX_HOURS: 'More than 6 Hours ago',
      LAST_TWELVE_HOURS: 'More than 12 Hours ago',
      LAST_TWENTY_FOUR_HOURS: 'More than 24 Hours ago',
      LAST_TWO_DAYS: 'More than 2 Days ago',
      LAST_SEVEN_DAYS: 'More than 7 Days ago',
      LAST_TWO_WEEKS: 'More than 2 Weeks ago',
      LAST_ONE_MONTH: 'More than 1 Month ago',
      LAST_THREE_MONTH: 'More than 3 Month ago',
      LAST_SIX_MONTH: 'More than 6 Month ago',
