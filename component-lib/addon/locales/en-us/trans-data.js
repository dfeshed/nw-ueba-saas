...
effects the simulated source.',
    ...
    policyWizard: {
      ...
      edrPolicy: {
        ...
        isolationEnabledTooltip: 'Network Isolation blocks the host from connecting to the network.<br>All attempted network connections are monitored and reported to the Endpoint Server.',
