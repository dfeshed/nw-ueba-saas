...
effects the simulated source.',
    ...
    policyWizard: {
      ...
      filePolicy: {
        ...
        protocol: 'Protocol',
        protocolTooltip: 'Select whether SSL, TCP, or UDP transport protocol is used to forward the collected logs to the NetWitness Platform servers. SSL is recommended but note that it is a resource intensive option. TCP is reliable but unsecure, which may be acceptable within a corporate network. Finally, UDP is unsecure and delivery is not guaranteed.',
        advancedConfig: 'Advanced Configuration',
        customConfig: 'Advanced Setting',
        customConfigTooltip: 'It is strongly recommended not to use this setting unless advised to by RSA support staff.',
        customConfigInvalidMsg: 'The custom setting cannot be empty or greater than 4000 characters',
