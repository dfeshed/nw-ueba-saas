export default {
  ...
  adminUsm: {
    ...
    //   scanMbr: 'Download Master Boot Record',
    ...
    policyWizard: {
      ...
      edrPolicy: {
        ...
        primaryAddressTooltip: 'The primary addresses of all your Endpoint servers will be automatically populated by NetWitness and will be available for selection from the dropdown. The Endpoint server once added to a policy cannot be left blank.',
        primaryAddressInvalidMsg: 'The endpoint server host name should not be empty',
        primaryAlias: 'Endpoint Server Alias (Optional)',
        primaryAliasTooltip: 'The optional Endpoint Server alias allows you to enter an alternative hostname or IP address on which the server can be reached in the case that agents need to go through a NAT or similar in order to reach the Endpoint Server.',
