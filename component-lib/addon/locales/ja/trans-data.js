export default {
  ...
  recon: {
    ...
    eventHeader: {
      ...
      packetSizeTooltip: 'ja_The calculated packet size in the summary header information may be greater than the packet size in the meta details panel because the meta data is sometimes written before event parsing completes.',
      payloadSizeTooltip: 'ja_The payload size in the summary header information may be greater than the payload size in the meta details panel because the meta data is sometimes written before event parsing completes.',
      packetCountTooltip: 'ja_The calculated packet count in the summary header information may be greater than the packet count in the meta details panel because the meta data is sometimes written before event parsing completes.',
