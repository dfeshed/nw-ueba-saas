export default {
  ...
  recon: {
    ...
    eventHeader: {
      ...
      nweProcessParentFilename: 'ja_Process Parent Filename',
      nweProcessPath: 'ja_Process Path',
      nweDllFilename: 'ja_DLL Filename',
      nweDllPath: 'ja_DLL Path',
      nweDllProcessFilename: 'ja_DLL Process Filename',
  ...
  context: {
    ...
    error: {
      ...
      'total.entries.exceed.max': 'ja_List size exceeds the limit 100K.',
