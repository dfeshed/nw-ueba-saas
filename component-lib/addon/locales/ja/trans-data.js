export default {
  ...
  userPreferences: {
    ...
    locale: {
      ...
      fetchError: 'ja_There was an error attempting to load your Language selection. Please try again. If this issue persists, please contact your system admin.'
    },
  ...
  recon: {
    ...
    error: {
      ...
      noRawDataEndpoint: 'ja_No text data was generated during content reconstruction. This could mean that the event data was corrupt/invalid, or that an administrator has disabled the transmission of raw endpoint events in the Endpoint server configuration. Check the other reconstruction views.',
  ...
  investigate: {
    ...
    freeForm: {
      ...
      placeholder: 'ja_Free Form Query Bar'
    },
    nextGen: {
      linkTitle: 'ja_Next Gen Mode',
      placeholder: 'ja_Next Gen Query Bar'
    },
    size: {
      bytes: 'ja_bytes',
      KB: 'ja_KB',
      ...
      eventTips: {
        ...
        section: {
          mouse: {
            ...
            textFour: 'ja_Click multiple filters and press <span class="highlight">Delete</span> to remove selected filters.',
  ...
  context: {
    ...
    error: {
      ...
      archer: {
        noData: 'ja_Data in RSA Archer is not available.',
        notConfigured: 'ja_Archer data source is not configured and refer help documentation to configure.',
        notReachable: 'ja_Check the data source connectivity to Archer.'
      }
    },
    footer: {
      viewAll: 'ja_VIEW All',
  ...
  investigateHosts: {
    ...
    hosts: {
      ...
      propertyPanelTitles: {
        autoruns: {
          autorun: 'ja_Autorun Properties',
          services: 'ja_Service Properties',
          tasks: 'ja_Task Properties'
        },
        files: 'ja_File Properties',
        drivers: 'ja_Driver Properties',
        libraries: 'ja_Library Properties'
      },
      medium: {
        network: 'ja_Network',
        log: 'ja_Log',
      ...
      deleteHosts: {
        modal: {
          ...
          message: 'ja_Delete the host if the host scan data is no longer required or the agent is uninstalled. ' +
