export default {
  ...
  recon: {
    ...
    eventHeader: {
      ...
      payloadSizeTooltip: 'ja_The payload size in the summary header may be greater than the payload size in the meta details panel because the meta data is sometimes written before event parsing completes and may include packet duplicates.',
