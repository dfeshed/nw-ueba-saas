...
import { SINCE_WHEN_TYPES } from 'component-lib/utils/rsa-explorer/since-when-types';
...
export default Component.extend({
  ...
  filterControlsComponent: 'rsa-explorer/stub',
  ...
  actions: {
    ...
    onChangeTimeframe(timeframe) {
      ...
      this.updateFilter({ [dateFilterField]: timeframe });
    },
