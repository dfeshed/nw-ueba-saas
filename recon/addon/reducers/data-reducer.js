...
const data = handleActions({
  [ACTION_TYPES.INITIALIZE]: (state, { payload: { endpointId, eventId, isStandalone, queryInputs } }) => {
    return dataInitialState.merge({ endpointId, eventId, isStandalone, queryInputs, contentLoading: true });
  },
