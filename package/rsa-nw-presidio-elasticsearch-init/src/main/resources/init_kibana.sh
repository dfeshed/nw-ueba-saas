...
/usr/share/kibana/bin/kibana-plugin install file:///var/lib/netwitness/presidio/elasticsearch/init/kibana-plugins/kibana_dropdown_5.6.9.zip -d /usr/share/kibana/plugins/
...
unzip -o /var/lib/netwitness/presidio/elasticsearch/init/kibana-plugins/kibana_dropdown_5.6.9.zip -d /usr/share/kibana/plugins/
...
mv /usr/share/kibana/plugins/kibana/kibana_dropdown_5.6.9/* /usr/share/kibana/plugins/kibana_dropdown/
