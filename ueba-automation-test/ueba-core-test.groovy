...
pipeline {
    parameters {
        ...
        string(name: 'generator_format', choices: ['MONGO_ADAPTER','S3_JSON_GZIP'], description: '')
        string(name: 'pre_processing_configuration_scenario', choices: ['CORE_MONGO','CORE_S3'], description: '')
