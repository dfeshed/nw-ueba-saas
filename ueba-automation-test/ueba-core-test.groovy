...
pipeline {
    parameters {
        ...
        string(name: 'generator_format', defaultValue: 'MONGO_ADAPTER,S3_JSON_GZIP', description: '')
        string(name: 'pre_processing_configuration_scenario', defaultValue: 'CORE_MONGO,CORE_S3', description: '')
