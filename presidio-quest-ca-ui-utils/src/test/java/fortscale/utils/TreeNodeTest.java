...
public class TreeNodeTest {
	...
	public void test_getListOfLeaf()
	{
		...
		ArrayList<TreeNode<Integer>> actualListofleaf =root.getListOfLeaf();
		ArrayList<TreeNode<Integer>> expextedListofleaf =new ArrayList<>();
		...
		for (TreeNode<Integer> expectedLeaf : expextedListofleaf)
		{
			boolean innerFlag = false;
			for (TreeNode<Integer> actualLeaf : actualListofleaf)
			{
