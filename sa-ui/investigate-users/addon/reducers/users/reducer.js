...
const tabs = handleActions({
  ...
  [ACTION_TYPES.UPDATE_ENTITY_TYPE_FOR_OVERVIEW]: (state, { payload }) => state.set('entityTypeForOverview', payload),
  ...
  [ACTION_TYPES.UPDATE_SELECTED_FAVORITE]: (state, { payload }) => state.set('selectedFavorite', payload),
