...
import originalService from 'investigate-users/services/redux';

const { unsee } = require;

export function applyPatch(initState) {
  unsee('investigate-users/services/redux');

  define('investigate-users/services/redux', ['exports', 'redux', 'ember-redux/services/redux', 'investigate-users/reducers/index', 'redux-thunk', 'redux-pack'], function(exports, _redux, _redux2, _index, _reduxThunk, _reduxPack) {
    'use strict';
...
export function revertPatch() {
  ...
  define('investigate-users/services/redux', ['exports'], function(exports) {
