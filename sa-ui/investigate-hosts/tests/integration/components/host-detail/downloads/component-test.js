...
module('Integration | Component | downloads', function(hooks) {
  ...
  test('Downloads column names', async function(assert) {
    ...
    assert.ok(find('.rsa-data-table-header-cell:nth-child(1) .rsa-form-checkbox-label'), 'Column 1 is a checkbox');
    assert.equal(find('.rsa-data-table-header-cell:nth-child(2)').textContent.trim(), 'File name', 'Column 2 is File name');
    assert.equal(find('.rsa-data-table-header-cell:nth-child(3)').textContent.trim(), 'Type', 'Column 3 is Type');
    assert.equal(find('.rsa-data-table-header-cell:nth-child(4)').textContent.trim(), 'Downloaded', 'Column 4 is Downloaded');
    assert.equal(find('.rsa-data-table-header-cell:nth-child(5)').textContent.trim(), 'Size', 'Column 5 is Size');
    assert.equal(find('.rsa-data-table-header-cell:nth-child(6)').textContent.trim(), 'Downloaded Time', 'Column 6 is Downloaded Time');
    assert.equal(find('.rsa-data-table-header-cell:nth-child(7)').textContent.trim(), 'SHA256', 'Column 7 is SHA256');
