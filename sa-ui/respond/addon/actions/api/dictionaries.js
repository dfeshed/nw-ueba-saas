...
export default {
   ...
   */
  getAllAlertSources() {
    const alertSources = ['ECAT', 'Event Stream Analysis', 'Malware Analysis', 'NetWitness Investigate', 'Reporting Engine', 'Risk Scoring', 'User Entity Behavior Analytics', 'Web Threat Detection'];
