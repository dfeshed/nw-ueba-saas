...
module('Integration | Component | rsa-collapseable-actions/expanded', function(hooks) {
  ...
  test('it renders dropdowns', async function(assert) {
    ...
    await render(hbs `{{rsa-collapseable-actions/expanded dropdownList=dropdownList}}`);
  ...
  test('it renders buttons', async function(assert) {
    ...
    await render(hbs `{{rsa-collapseable-actions/expanded buttonList=buttonList}}`);
    ...
    assert.equal(findAll('.buttons > .rsa-form-button-wrapper')[1].textContent.trim(), 'Secondary Button');
    ...
    assert.equal(find('.buttons > .rsa-button-group:nth-child(4) .rsa-form-button-wrapper').textContent.trim(), 'Secondary Group 1');
  });
  ...
  test('it renders toggles', async function(assert) {
    ...
    await render(hbs `{{rsa-collapseable-actions/expanded toggleList=toggleList}}`);
