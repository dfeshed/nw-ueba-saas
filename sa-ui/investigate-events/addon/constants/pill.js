...
export const AFTER_OPTION_TEXT_DISABLED_DUPLICATE_LABEL = 'Text Filter is unavailable. Only one is permitted.';
export const AFTER_OPTION_TEXT_DISABLED_PARENS_LABEL = 'Text filters are not supported inside parentheses.';
...
export const OPERATORS = ['!exists', 'exists', 'length', 'regex', 'contains', 'begins', 'ends', '!=', '=', '<', '>'];
export const ALL_OPERATORS = [...OPERATORS, ...LOGICAL_OPERATORS, '(', ')', 'NOT'];
