window.addEventListener("load", function(){
    ...
    $("body").on("click", ".notification-dropdown .close-icon", function(e){
        var $dialog = $(e.currentTarget).closest(".pop-dialog").eq(0);
        var $trigger = $dialog.siblings(".trigger").eq(0);
    ...
    $("body").on("mousedown", "#dashboard-menu .dropdown-toggle", function(e) {
        e.preventDefault();
