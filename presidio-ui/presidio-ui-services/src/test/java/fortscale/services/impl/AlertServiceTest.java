...
//        FakeCreatorUtils fakeCreatorUtils = new FakeCreatorUtils();
//        FakeIndicatorCreators fakeIndicatorCreators = new FakeIndicatorCreators(fakeCreatorUtils);
//        FakeRemoteAlertClientService fakeRemoteAlertClientService =
//                new FakeRemoteAlertClientService(
//                        new FakeAlertsCreator(fakeCreatorUtils,fakeIndicatorCreators),
//                        fakeIndicatorCreators);
//
//        alertsService = new AlertsServiceImpl(userService,
//                new AlertConverterHelper(),new AlertCommentsServiceImpl(),new AggregationConverterHelper(),
//                fakeRemoteAlertClientService);
//    }
//
//    @Test
