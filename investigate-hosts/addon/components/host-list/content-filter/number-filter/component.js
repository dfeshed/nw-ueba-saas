...
const RESTRICTION_TYPES = [
  { name: 'investigateHosts.hosts.restrictionTypeOptions.EQUALS', type: 'EQUAL' },
  { name: 'investigateHosts.hosts.restrictionTypeOptions.GT', type: 'GREATER_THAN' },
  { name: 'investigateHosts.hosts.restrictionTypeOptions.LT', type: 'LESS_THAN' },
  { name: 'investigateHosts.hosts.restrictionTypeOptions.BETWEEN', type: 'BETWEEN' }
];
