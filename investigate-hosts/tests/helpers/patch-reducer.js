...
import originalService from 'investigate-hosts/services/redux';

const { unsee } = require;

export function applyPatch(initState) {
  unsee('investigate-hosts/services/redux');

  define('investigate-hosts/services/redux', ['exports', 'redux', 'ember-redux/services/redux', 'investigate-hosts/reducers/index', 'redux-thunk', 'redux-pack'], function(exports, _redux, _redux2, _index, _reduxThunk, _reduxPack) {
    'use strict';
...
export function revertPatch() {
  ...
  define('investigate-hosts/services/redux', ['exports'], function(exports) {
