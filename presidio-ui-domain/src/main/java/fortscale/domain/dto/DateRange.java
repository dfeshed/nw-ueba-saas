...
public class DateRange {
    ...
    public boolean checkBetween(long time){
        long timeTimeStamp=TimestampUtils.convertToMilliSeconds(time);
        long fromTimeStamp=TimestampUtils.convertToMilliSeconds(this.fromTime);
        long toTimeStamp=TimestampUtils.convertToMilliSeconds(this.toTime);


        return (timeTimeStamp>=fromTimeStamp&& timeTimeStamp<=toTimeStamp);
    }
}
