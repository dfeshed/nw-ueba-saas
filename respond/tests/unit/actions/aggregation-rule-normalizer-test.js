...
module('Unit | Utility | Aggregation Rule Normalizer');

// All of the match conditions in an aggregation rule are persisted as stringified JSON. The match conditions are
