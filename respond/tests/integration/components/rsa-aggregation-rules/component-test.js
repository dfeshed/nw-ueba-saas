...
moduleForComponent('rsa-aggregation-rules', 'Integration | Component | Respond Aggregation Rules', {
  integration: true,
...
test('The component appears in the DOM with the expected number of rows', function(assert) {
  ...
  this.render(hbs`{{rsa-aggregation-rules useLazyRendering=false}}`);
  assert.equal(this.$('.rsa-aggregation-rules').length, 1, 'The component appears in the DOM');
