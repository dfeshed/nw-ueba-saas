...
export default {
   ...
   */
  getAllAlertSources() {
    const alertSources = ['Risk Scoring', 'ECAT', 'Event Stream Analysis', 'Malware Analysis', 'NetWitness Investigate', 'Reporting Engine', 'User Entity Behavior Analytics', 'Web Threat Detection'];
