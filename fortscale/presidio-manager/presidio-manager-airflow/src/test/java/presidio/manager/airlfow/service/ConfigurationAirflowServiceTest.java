...
public class ConfigurationAirflowServiceTest {
    ...
    public void validConfiguration() throws IOException {
        ...
        OutputConfiguration outputConfiguration = new OutputConfiguration(jsonNode2);
        PresidioManagerConfiguration presidioManagerConfiguration = new PresidioManagerConfiguration(dataPipeline, systemConf, outputConfiguration);
