...
public class ConfigurationProcessingMngServiceTest {
    ...
    public void setNodes() {
        ...
        configurationManagerService = new ConfigurationManagerService(new ConfigurationAirflowServcie(null,"workflows",null,null), new ConfigurationSecurityService(null, null, "/tmp/httpdtest.conf"));
    }
