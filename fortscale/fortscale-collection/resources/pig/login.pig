...
loginFields     = FOREACH loginUsersOnlyNoFailedDC GENERATE generatedTime,LOWER(machineName) as source_machine,((failureCode is null) or ((failureCode != '0x12') and (failureCode != '0x22')) ? '0x0' : generatedTime),failureCode,normalized_username,eventCode,LOWER(accountName) as account_name;
...
loginFinalScore	= FOREACH loginScore GENERATE $0 as time,$1 as normalizedtime,$2 as hostname,$4 as errorcode,$5 as normalized_username,$6 as eventCode,$7 as accountname, $8 as timescore,$9 as hostnamescore,$10 as errorcodescore,$11 as eventscore,$12 as globalscore,$13 as entitygroupedbyid;
