...
def validate_cleanup_complete(logger, host, validation_timeout, validation_polling):
    return validate_collections_are_empty(logger=logger,
                                          log_msg='validating cleanup 1/2...',
                                          host=host,
           ...
           validate_collections_are_empty(logger=logger,
                                          log_msg='validating cleanup 2/2...',
                                          host=host,
