	...
	@SuppressWarnings("unused")
 	private Object[] parametersForTest() {
        return	$(
		    	...
		    	"2014-06-17T09:00:00.000-04:00,2014-06-17 09:00:00,Kerberos Service Ticket Operations,4769,Security,97628557,Microsoft Windows security auditing.,IL-SP-P-DARFAMM@FORTSCALE.COM,FORTSCALE.COM,IL-SP-P-DARFAMM,TLV_DOMAIN\\IL-SP-P-DARFAMM,172.16.28.178,0x40810008,0x0,,1402984800,false,,,,,false,false,false"
        		),
        		$ (
		        ...
		        "2014-06-17T09:00:00.000-04:00|06/17/2014 09:00:00 AM	LogName=Security	SourceName=Microsoft Windows security auditing.	EventCode=4769	EventType=0	Type=Information	ComputerName=TLVXDCP01.Fortscale.com	TaskCategory=Kerberos Service Ticket Operations	OpCode=Info	RecordNumber=97628557	Keywords=Audit Success	Message=A Kerberos service ticket was requested.		Account Information:		Account Name:		krbtgt		Account Domain:		FORTSCALE.COM		Logon GUID:		{7160E105-C605-2936-2B43-B3D49C5EED29}		Service Information:		Service Name:		IL-SP-P-DARFAMM		Service ID:		TLV_DOMAIN\\IL-SP-P-DARFAMM		Network Information:		Client Address:		::ffff:172.16.28.178		Client Port:		61285		Additional Information:		Ticket Options:		0x40810008		Ticket Encryption Type:	0x12		Failure Code:		0x0		Transited Services:	-		This event is generated every time access is requested to a resource such as a computer or a Windows service.  The service name indicates the resource to which access was requested.		This event can be correlated with Windows logon events by comparing the Logon GUID fields in each event.  The logon event occurs on the machine that was accessed, which is often a different machine than the domain controller which issued the service ticket.		Ticket options, encryption types, and failure codes are defined in RFC 4120.",
		    	null
        		),
				$ (
        		"4769 Event with krbtgt Service Name and Domain (Should be dropped)",
		        "2014-06-17T09:00:00.000-04:00|06/17/2014 09:00:00 AM	LogName=Security	SourceName=Microsoft Windows security auditing.	EventCode=4769	EventType=0	Type=Information	ComputerName=TLVXDCP01.Fortscale.com	TaskCategory=Kerberos Service Ticket Operations	OpCode=Info	RecordNumber=97628557	Keywords=Audit Success	Message=A Kerberos service ticket was requested.		Account Information:		Account Name:		krbtgt@FORTSCALE.DOM		Account Domain:		FORTSCALE.COM		Logon GUID:		{7160E105-C605-2936-2B43-B3D49C5EED29}		Service Information:		Service Name:		IL-SP-P-DARFAMM		Service ID:		TLV_DOMAIN\\IL-SP-P-DARFAMM		Network Information:		Client Address:		::ffff:172.16.28.178		Client Port:		61285		Additional Information:		Ticket Options:		0x40810008		Ticket Encryption Type:	0x12		Failure Code:		0x0		Transited Services:	-		This event is generated every time access is requested to a resource such as a computer or a Windows service.  The service name indicates the resource to which access was requested.		This event can be correlated with Windows logon events by comparing the Logon GUID fields in each event.  The logon event occurs on the machine that was accessed, which is often a different machine than the domain controller which issued the service ticket.		Ticket options, encryption types, and failure codes are defined in RFC 4120.",
		    	null
        		)        		
        );
 	}
