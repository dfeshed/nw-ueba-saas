	...
	private Object[] parametersForTest() {
        return	$(
    		$(
	    		...
	    		$(
    				(String)null,
	    			"2014-01-02 19:08:35,1388707715,chavier,75.26.245.200,172.10.10.10,SUCCESS,UNITED STATES,ILLINOIS,MORTON GROVE,AT&T INTERNET SERVICES,isp,"
	    		)
    		),
    		...
    		$(
    	    	...
    	    	$(
        			(String)null,
    	    		"2014-01-02 19:06:26,1388707586,bartra,69.141.27.100,172.10.11.12,FAIL,UNITED STATES,NEW JERSEY,JERSEY CITY,COMCAST CABLE COMMUNICATIONS INC.,isp,"
    	    	)
        	),
    		...
    		$(
	    		...
	    		$(
    				(String)null,
	    			"2013-12-02 19:08:35,1386029315,chavier,75.26.245.200,172.10.10.10,SUCCESS,UNITED STATES,ILLINOIS,MORTON GROVE,AT&T INTERNET SERVICES,isp,"
	    		)
    		)
		);
    }
