...
public class SecEventsSyslog4768OnlyLocalTimezoneCompTest {
	...
	private String confFile = "resources/conf-files/readSecEvtOnlyComp_syslog.conf";
	private String conf4768File = "resources/conf-files/read4768SecEvtOnlyComp_syslog.conf";
	...
	public void test_winter() {
		...
		String expectedOutput = "1422728323,192.168.7.87,IL-TMUROTDB$,IL.PLAYTECH.CORP,il-dc1";
	...
	public void test_summer() {
		...
		String expectedOutput = "1433092723,192.168.7.87,IL-TMUROTDB$,IL.PLAYTECH.CORP,il-dc1";
