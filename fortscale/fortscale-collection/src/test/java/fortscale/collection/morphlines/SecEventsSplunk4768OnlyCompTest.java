...
public class SecEventsSplunk4768OnlyCompTest {
	...
	public void setUp() throws Exception {
		List<String> fieldsToCheck = Arrays.asList("timeGeneratedUnixTime","client_address","account_name","account_domain","reporting_server");
	...
	@SuppressWarnings("unused")
 	private Object[] parametersForTest() {
        return	$(
    		...
    		"1393241920,192.168.0.107,maxk$,FORTSCALE.DOM,Fs-DC-01.Fortscale.dom"
    		)
        );
 	}
