...
public class SecEvents4769MessageTest {
	...
	final static String May_28_14_09_40 = "May 28 14:09:40";
	static String May_28_14_09_40_OUT;
	...
	@SuppressWarnings("deprecation") private static void prepareDates() {
		...
		Date date = TestUtils.constuctDate(May_28_14_09_40);
		SimpleDateFormat df = new SimpleDateFormat("yyyy");
		year_case1 = df.format(date);
		May_28_14_09_40_OUT = TestUtils.getOutputDate(date);
	...
	public void setUp() throws Exception {
		...
		String kafkaMessageFields = propertiesResolver.getProperty("kafka.kerberos_logins.message.record.fields");
	...
	private Object[] parametersForTest() {
		...
		return	$(
				...
				$ (
						...
						May_31_20_18_44+","+May_31_20_18_44_OUT+",Kerberos Service Ticket Operations,4769,Security,1,Microsoft Windows security auditing.,asher_y@IL.PLAYTECH.CORP,IL.PLAYTECH.CORP,IL-CAS1,S-1-5-21-2289726844-590661003-2420928919-8351,192.168.7.34,0x40810000,0x0,,"+runtime_May_31_20_18_44+",,false,,,,,,,,,,,kerberos_logins,etl"
				),
				$ (
