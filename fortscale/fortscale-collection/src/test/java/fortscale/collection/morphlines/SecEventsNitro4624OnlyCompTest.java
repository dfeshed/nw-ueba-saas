...
public class SecEventsNitro4624OnlyCompTest {
	...
	private String confFile = "resources/conf-files/readSecEvtOnlyComp_nitro.conf";
	private String conf4624File = "resources/conf-files/read4624SecEvtOnlyComp_nitro.conf";
