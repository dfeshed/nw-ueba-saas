...
public class SecEventsNitro4768OnlyCompTest {

	private MorphlinesTester morphlineTester = new MorphlinesTester();
	private String confFile = "resources/conf-files/securityevents/nitro/readSecEvtOnlyComp.conf";
	private String conf4768File = "resources/conf-files/securityevents/nitro/read4768SecEvtOnlyComp.conf";
	...
	@SuppressWarnings("unused")
 	private Object[] parametersForTest() {
        return	$(
    		...
    		"1446335487,10.8.48.74,SAPServiceLVM,sicpa-net,SNCH2DCS01.sicpa-net.ads"
    		)
        );
 	}
