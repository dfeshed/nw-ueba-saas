...
public class SecEventsSA4624OnlyCompTest {

	private MorphlinesTester morphlineTester = new MorphlinesTester();
	private String confFile = "resources/conf-files/securityevents/securityAnalytics/readSecEvtOnlyComp.conf";
 	...
 	private Object[] parametersForTest() {
        return	$(
				$ (
						...
						"1448292529,10.81.88.73,CHNSHLMBX12$,ITLINFOSYS,ty_4624_Microsoft-Windows-Security-Auditing:"
				)
