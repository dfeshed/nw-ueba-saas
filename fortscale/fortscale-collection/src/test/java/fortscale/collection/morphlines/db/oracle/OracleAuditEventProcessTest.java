    ...
    private Object[] parametersForTest() {
        return	$(
                $(
                        ...
                        $(
                                "2016-12-07 16:05:45,1481126745,apache,MAILQAPP,cppums1-mailq-privil-01.crossperf.ptec,tar1310.crossperf.ptec,10.143.70.216,131437128,,Login,0,5",
                                "2016-12-07 16:05:22,1481126722,nginx,POTOOLS,poms.po.ptec,casino2-ums-db-01.pokerperf.ptec,192.168.8.168,3599862714,,Login,0,5",
                                "2016-12-07 18:05:06,1481133906,playtech,CRON,extdev-extdev2-admin.extdev.ptec,extdev-extdev2-db.extdev.ptec,10.27.3.141,3559652912,,Login,0,5"
                        )
                ),
                $(
                        "Select Events",
                        ...
                        $(
                                "2016-12-07 18:05:20,1481133920,apps,JAVA,umsdev1-cas-priva-game-01.ums.ptec,umsdev1-ums-db-01.ums.ptec,,3678712847,MPGAMETABLES,Select,942,",
                                "2016-12-06 18:05:03,1481047503,apps,JAVA,umsdev1-cas-pub-server-01.ums.ptec,umsdev1-ums-db-01.ums.ptec,,3678712847,JACKPOTS,Select,942,",
                                "2016-12-07 18:05:09,1481133909,apps,JAVA,umsdev1-cas-pub-server-01.ums.ptec,umsdev1-ums-db-01.ums.ptec,,3678712847,CASINOJACKPOTS,Select,942,"
                        )
                ),
                $(
