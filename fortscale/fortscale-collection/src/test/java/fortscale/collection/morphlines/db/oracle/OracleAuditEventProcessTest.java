    ...
    private Object[] parametersForTest() {
        return	$(
                $(
                        "Logon Events",
                        $(
                                "Dec  7 16:05:45 tar1310.crossperf.ptec Oracle Audit[11974]: [ID 748625 local7.warning] LENGTH: \"357\" SESSIONID:[8] \"20924831\" ENTRYID:[1] \"1\" STATEMENT:[1] \"1\" USERID:[8] \"MAILQAPP\" USERHOST:[38] \"cppums1-mailq-privil-01.crossperf.ptec\" ACTION:[3] \"100\" RETURNCODE:[1] \"0\" COMMENT$TEXT:[100] \"Authenticated by: DATABASE; Client address: (ADDRESS=(PROTOCOL=tcp)(HOST=10.143.70.216)(PORT=43679))\" OS$USERID:[6] \"apache\" DBID:[9] \"131437128\" PRIV$USED:[1] \"5\"",
                                "Dec  7 16:05:22 casino2-ums-db-01.pokerperf.ptec Oracle Audit[10367]: [ID 748625 local7.warning] LENGTH: \"332\" SESSIONID:[9] \"464285491\" ENTRYID:[1] \"1\" STATEMENT:[1] \"1\" USERID:[7] \"POTOOLS\" USERHOST:[12] \"poms.po.ptec\" ACTION:[3] \"100\" RETURNCODE:[1] \"0\" COMMENT$TEXT:[100] \"Authenticated by: DATABASE; Client address: (ADDRESS=(PROTOCOL=tcp)(HOST=192.168.8.168)(PORT=49215))\" OS$USERID:[5] \"nginx\" DBID:[10] \"3599862714\" PRIV$USED:[1] \"5\"",
                                "Dec  7 18:05:06 extdev-extdev2-db.extdev.ptec Oracle Audit[26217]: [ID 748625 local7.warning] LENGTH: \"349\" SESSIONID:[9] \"141101902\" ENTRYID:[1] \"1\" STATEMENT:[1] \"1\" USERID:[4] \"CRON\" USERHOST:[32] \"extdev-extdev2-admin.extdev.ptec\" ACTION:[3] \"100\" RETURNCODE:[1] \"0\" COMMENT$TEXT:[98] \"Authenticated by: DATABASE; Client address: (ADDRESS=(PROTOCOL=tcp)(HOST=10.27.3.141)(PORT=41165))\" OS$USERID:[8] \"playtech\" DBID:[10] \"3559652912\" PRIV$USED:[1] \"5\""
                        ),
                        $(
                                "2015-12-07 16:05:45,1449504345,apache,MAILQAPP,cppums1-mailq-privil-01.crossperf.ptec,tar1310.crossperf.ptec,10.143.70.216,131437128,,0",
                                "2015-12-07 16:05:22,1449504322,nginx,POTOOLS,poms.po.ptec,casino2-ums-db-01.pokerperf.ptec,192.168.8.168,3599862714,,0",
                                "2015-12-07 18:05:06,1449511506,playtech,CRON,extdev-extdev2-admin.extdev.ptec,extdev-extdev2-db.extdev.ptec,10.27.3.141,3559652912,,0"
                        )
                ),
                $(
                        "Select Events",
                        $(
                                ...
                                "Dec  6 18:05:03 umsdev1-ums-db-01.ums.ptec Oracle Audit[28856]: [ID 748625 local7.warning] LENGTH: \"290\" SESSIONID:[8] \"13052307\" ENTRYID:[5] \"24044\" STATEMENT:[5] \"50540\" USERID:[4] \"JAVA\" USERHOST:[34] \"umsdev1-cas-pub-server-01.ums.ptec\" TERMINAL:[7] \"unknown\" ACTION:[1] \"3\" RETURNCODE:[3] \"942\" OBJ$CREATOR:[6] \"GAMING\" OBJ$NAME:[8] \"JACKPOTS\" OS$USERID:[4] \"apps\" DBID:[10] \"3678712847\"\"",
                                "Dec  7 18:05:09 umsdev1-ums-db-01.ums.ptec Oracle Audit[28742]: [ID 748625 local7.warning] LENGTH: \"297\" SESSIONID:[8] \"13052271\" ENTRYID:[5] \"23931\" STATEMENT:[5] \"50428\" USERID:[4] \"JAVA\" USERHOST:[34] \"umsdev1-cas-pub-server-01.ums.ptec\" TERMINAL:[7] \"unknown\" ACTION:[1] \"3\" RETURNCODE:[3] \"942\" OBJ$CREATOR:[6] \"GAMING\" OBJ$NAME:[14] \"CASINOJACKPOTS\" OS$USERID:[4] \"apps\" DBID:[10] \"3678712847\"\""

                        ),
                        $(
                                "2015-12-07 18:05:20,1449511520,apps,JAVA,umsdev1-cas-priva-game-01.ums.ptec,umsdev1-ums-db-01.ums.ptec,,3678712847,MPGAMETABLES,942",
                                "2015-12-06 18:05:03,1449425103,apps,JAVA,umsdev1-cas-pub-server-01.ums.ptec,umsdev1-ums-db-01.ums.ptec,,3678712847,JACKPOTS,942",
                                "2015-12-07 18:05:09,1449511509,apps,JAVA,umsdev1-cas-pub-server-01.ums.ptec,umsdev1-ums-db-01.ums.ptec,,3678712847,CASINOJACKPOTS,942"
                        )
                ),
                $(
