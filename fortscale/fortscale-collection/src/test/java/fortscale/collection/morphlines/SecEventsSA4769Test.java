...
public class SecEventsSA4769Test {
	...
	public void setUp() throws Exception {
		...
		System.out.println(impalaTableFields);
	...
	@SuppressWarnings("unused")
 	private Object[] parametersForTest() {
        return	$(
		    	...
		    	"2014-03-17T15:49:21.000+02:00,2014-03-17 15:49:21,,4769,,,microsoft-windows-security-auditing,roman_s@IL.PLAYTECH.CORP,IL.PLAYTECH.CORP,IL-EXCH,S-1-5-21-2289726844-590661003-2420928919-6123,192.168.158.167,0x40810000,0x0,,1395064161,false,,,,,false,false,false"
        		),
		    	...
		    	"2014-03-17T13:49:03.000+02:00,2014-03-17 13:49:03,,4769,Security,668424399,Microsoft-Windows-Security-Auditing,Plamenv@BG.PLAYTECH.CORP,BG.PLAYTECH.CORP,BG-DC1,S-1-5-21-3421828858-1269048617-336047487-1898,192.168.203.228,0x40800000,0x0,,1395056943,false,,,,,false,false,false"
        		),
        		$ (
		        "4769 with krbtgt (should be dropped)", 
		    	"May  1 10:14:55 roee-hd5 %NICWIN-4-Security_4769_Microsoft-Windows-Security-Auditing: Security,rn=668424399 cid=11272 eid=628,Mon Mar 17 13:49:03 2014,4769,Microsoft-Windows-Security-Auditing,,Audit Success,BG-DC1.bg.playtech.corp,Kerberos Service Ticket Operations,,A Kerberos service ticket was requested.  Account Information:  Account Name:  krbtgt  Account Domain:  BG.PLAYTECH.CORP  Logon GUID:  {C3A9E22D-636B-22E1-B056-F86D42CD69AD}  Service Information:  Service Name:  BG-DC1$  Service ID:  S-1-5-21-3421828858-1269048617-336047487-1898  Network Information:  Client Address:  ::ffff:192.168.203.228  Client Port:  64165  Additional Information:  Ticket Options:  0x40800000  Ticket Encryption Type: 0x12  Failure Code:  0x0  Transited Services: -  This event is generated every time access is requested to a resource such as a computer or a Windows service.  The service name indicates the resource to which access was requested.  This event can be correlated with Windows logon events by comparing the Logon GUID fields in each event.  The logon event occurs on the machine that was accessed, which is often a different machine than the domain controller which issued the service ticket.  Ticket options, encryption types, and failure codes are defined in RFC 4120.",
		    	null
        		),
        		$ (
				"4769 with krbtgt full domain name (should be dropped)", 
		    	"May  1 10:14:55 roee-hd5 %NICWIN-4-Security_4769_Microsoft-Windows-Security-Auditing: Security,rn=668424399 cid=11272 eid=628,Mon Mar 17 13:49:03 2014,4769,Microsoft-Windows-Security-Auditing,,Audit Success,BG-DC1.bg.playtech.corp,Kerberos Service Ticket Operations,,A Kerberos service ticket was requested.  Account Information:  Account Name:  krbtgt@BG.PLAYTECH.CORP  Account Domain:  BG.PLAYTECH.CORP  Logon GUID:  {C3A9E22D-636B-22E1-B056-F86D42CD69AD}  Service Information:  Service Name:  BG-DC1$  Service ID:  S-1-5-21-3421828858-1269048617-336047487-1898  Network Information:  Client Address:  ::ffff:192.168.203.228  Client Port:  64165  Additional Information:  Ticket Options:  0x40800000  Ticket Encryption Type: 0x12  Failure Code:  0x0  Transited Services: -  This event is generated every time access is requested to a resource such as a computer or a Windows service.  The service name indicates the resource to which access was requested.  This event can be correlated with Windows logon events by comparing the Logon GUID fields in each event.  The logon event occurs on the machine that was accessed, which is often a different machine than the domain controller which issued the service ticket.  Ticket options, encryption types, and failure codes are defined in RFC 4120.",
		    	null
        		)
        );
 	}
