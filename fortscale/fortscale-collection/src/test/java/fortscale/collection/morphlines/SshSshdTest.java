...
public class SshSshdTest {
	...
	private Object[] parametersForTestSshSingleLines() {
        ...
        return	$(
        		...
        		year + "-11-19 14:58:32," + runtime + ",192.168.200.254,dev-gever,root,Accepted,password,,,,false"
				),
        		$ (
        		"Successful Public Key Authentication",
        		"Nov 19 14:58:32 dev-gever sshd[2591]: Accepted publickey for root from 192.168.55.55 port 38681 ssh2",
        		year + "-11-19 14:58:32," + runtime + ",192.168.55.55,dev-gever,root,Accepted,publickey,,,,false"),
        		$ (
        		...
        		year + "-11-19 14:58:32," + runtime + ",192.168.0.22,dev-gever,root,Accepted,publickey,,,,true"),
        		$ (
        		...
        		year + "-11-19 14:58:32," + runtime + ",192.168.211.112,inter-psg-01,root,Failed,password,,,,false"),
        		$ (
