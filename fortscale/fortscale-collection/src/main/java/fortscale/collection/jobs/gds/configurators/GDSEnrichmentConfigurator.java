 ...
 * 30/12/2015
 */
public class GDSEnrichmentConfigurator implements GDSConfigurator{
...
//        paramsMap.put("dataSourceLists", new ConfigurationParam("dataSourceLists", false, gdsConfigurationState.getExistingDataSources()));
//
