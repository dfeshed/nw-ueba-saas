...
public class GDSSchemaDefinitionCLIPopulator implements GDSConfigurationPopulator {
    ...
    private static final String BASE_SCORE_FIELD_TO_FIELD_NAME_CSV = "date_time_score date_time, source_machine_score normalized_src_machine, country_score country, destination_machine_score target_machine";
