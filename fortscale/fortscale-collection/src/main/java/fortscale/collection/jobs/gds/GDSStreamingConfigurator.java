 ...
 * 30/12/2015
 */
public class GDSStreamingConfigurator extends GDSBaseConfigurator{

    private static Logger logger = Logger.getLogger(GDSStreamingConfigurator.class);
    ...
    public GDSStreamingConfigurator(GDSConfigurationState gdsConfigurationState) {
...
//            handleBaseDataSourceDefinitions();
//        }
        ...
        try {
            ...
            result = bufferedReader.readLine().toLowerCase().equals("y");
    ...
    private void enrichStereamingConfiguration(BufferedReader br){
        ...
        try {
            ...
            brResult =bufferedReader.readLine().toLowerCase();
            ...
            String updateOnlyResult = bufferedReader.readLine().toLowerCase();
            ...
            if (((paramsMap.containsKey("sourceMachineNormalizationFlag") && paramsMap.get("sourceMachineNormalizationFlag").getParamFlag()) || (paramsMap.containsKey("targetMachineNormalizationFlag") && paramsMap.get("targetMachineNormalizationFlag").getParamFlag())) && executionResult)
            {
                ...
                Boolean ensureComputerExist = bufferedReader.readLine().toLowerCase().equals("y") || bufferedReader.readLine().toLowerCase().equals("yes");
            ...
            if (executionResult) {
                ...
                if (!anyRow) {
                    ...
                    //String statusFieldName =  bufferedReader.readLine().toLowerCase();
