...
import fortscale.services.configuration.Impl.ComputerTaggingClassConfigurationWriter;
...
public class GDSComputerTaggingConfigurator extends GDSBaseConfigurator {
    ...
    public GDSComputerTaggingConfigurator() {
        configurationWriterService = new ComputerTaggingClassConfigurationWriter();
    }
