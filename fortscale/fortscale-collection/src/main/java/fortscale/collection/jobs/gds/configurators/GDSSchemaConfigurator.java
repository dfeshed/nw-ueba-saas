...
import fortscale.collection.jobs.gds.populators.GDSUserConfigurationPopulator;
import fortscale.collection.jobs.gds.populators.SchemaDefinitionCLIPopulator;
...
public class GDSSchemaConfigurator extends GDSBaseConfigurator {
    ...
    private GDSUserConfigurationPopulator gdsUserConfigurationPopulator;
    ...
    public GDSSchemaConfigurator() {
        gdsUserConfigurationPopulator = new SchemaDefinitionCLIPopulator(gdsConfigurationState);
        initConfigurationService = new InitPartConfiguration();
    }

    public void configure() throws Exception {
        gdsUserConfigurationPopulator.populateConfigurationData();
//        super.configure();
//
