 ...
 */
public class ScoredRecordPageIterator<T extends AdeScoredRecord> implements PageIterator<T> {
    ...
    public ScoredRecordPageIterator(ScoredDataReader<T> scoredDataReader, TimeRange timeRange, MultiKeyFeature
            contextFieldNameToValueMap, String adeEventType, int pageSize) {
        ...
        long count = scoredDataReader.countScoredRecords(timeRange, contextFieldNameToValueMap, adeEventType);
        nextPageIndex = 0;
    ...
    public List<T> next() {
        ...
        List<T> scoredRecords = scoredDataReader.readScoredRecords(timeRange, contextFieldNameToValueMap,
                adeEventType, pageSize * nextPageIndex, pageSize);
        ++nextPageIndex;
