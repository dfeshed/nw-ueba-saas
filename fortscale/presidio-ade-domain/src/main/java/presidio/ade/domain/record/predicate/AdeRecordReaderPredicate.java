...
@JsonSubTypes({
        ...
        @JsonSubTypes.Type(value = NegateAdeRecordReaderPredicate.class, name = NegateAdeRecordReaderPredicate.ADE_RECORD_READER_PREDICATE_TYPE),
        ...
        @JsonSubTypes.Type(value = EqualsAdeRecordReaderPredicate.class, name = EqualsAdeRecordReaderPredicate.ADE_RECORD_READER_PREDICATE_TYPE)
})
