    ...
    public void setup() {
        ...
        for (int i = 0; i < AMOUNT_OF_FEATURE_AGGR_PER_CONTEXT_ID; i++) {
            ...
            for (int j = 0; j < AMOUNT_OF_GENERATED_CONTEXT_IDS; j++) {
                ...
                aggregatedDataStore.store(featureAggrRecords, FEATURE_AGGREGATION, new StoreMetadataProperties());
            }
        }
        ...
        for (int i = 0; i < AMOUNT_OF_SCORE_AGGR_PER_CONTEXT_ID; i++) {
            ...
            for (int j = 0; j < AMOUNT_OF_GENERATED_CONTEXT_IDS; j++) {
                ...
                aggregatedDataStore.store(scoreAggrRecords, SCORE_AGGREGATION, new StoreMetadataProperties());
            }
        }
    }
