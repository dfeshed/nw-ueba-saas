...
public class DataSourceToAdeScoredEnrichedRecordClassResolverConfigTest {
    ...
    public void testDlpfileIsResolved(){
        Class<? extends AdeScoredEnrichedRecord> record = dataSourceToAdeScoredEnrichedRecordClassResolver.getClass(PresidioSchemas.DLPFILE.toString().toLowerCase());
        Assert.assertTrue(record.equals(AdeScoredDlpFileRecord.class));
    }

    @Test
    public void testDlpmailIsNotResolved(){
        Class<? extends AdeScoredEnrichedRecord> record = dataSourceToAdeScoredEnrichedRecordClassResolver.getClass(PresidioSchemas.DLPMAIL.toString().toLowerCase());
