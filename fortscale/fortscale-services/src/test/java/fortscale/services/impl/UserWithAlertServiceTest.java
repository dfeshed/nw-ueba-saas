...
public class UserWithAlertServiceTest {
	...
	@InjectMocks
	private UserWithAlertServiceImpl userWithAlertService;
	...
	@Test
	public void testGetUsers_NoFilter(){
	...
	@Test
	public void testGetUsers_AlertTypeFilter_userFound(){
		PageRequest pageRequest = new PageRequest(1, 10);
		UserRestFilter userRestFilter = new UserRestFilter();
	...
	@Test
	public void testGetUsers_AlertTypeFilter_NoUserFound(){
		PageRequest pageRequest = new PageRequest(1, 10);
		UserRestFilter userRestFilter = new UserRestFilter();
		List<String> alertTypes = new ArrayList<>();
		alertTypes.add("anomalous_admin_activity_normalized_username_hourly");
	...
	@Test
	public void testGetUsers_IndicatorTypeFilter_UserFound(){
		PageRequest pageRequest = new PageRequest(1, 10);
		UserRestFilter userRestFilter = new UserRestFilter();
	...
	@Test
	public void testGetUsers_IndicatorTypeFilter_NoUserFound(){
		PageRequest pageRequest = new PageRequest(1, 10);
		UserRestFilter userRestFilter = new UserRestFilter();
		AlertRestFilter.DataSourceAnomalyTypePairListWrapper indicatorTypes = new AlertRestFilter.DataSourceAnomalyTypePairListWrapper();
		Set<DataSourceAnomalyTypePair> anomalyList = new HashSet<>();
	...
	@Test
	public void testGetUsers_IndicatorAndAlertTypeFilter_UserFound(){
		PageRequest pageRequest = new PageRequest(1, 10);
		UserRestFilter userRestFilter = new UserRestFilter();
	...
	@Test
	public void testGetUsers_IndicatorAndAlertTypeFilter_NoUserFound(){
		PageRequest pageRequest = new PageRequest(1, 10);
		UserRestFilter userRestFilter = new UserRestFilter();
