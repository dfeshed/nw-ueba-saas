...
public class QoSSanityService implements FeService {
	...
	public QoSSanityService(FeService feService) {
	...
	public Iterable<AdUser> getAdUsersAttrVals() {
		...
		return qos.generateSanityTestUsers(validUsers);
	}
	...
	public void setAdUsersScores(Map<String, Double> userScoresMap, Map<String, Collection<IFeature>> userFeaturesScoresMap, Date timeStamp) {
		qos.computeSanityTestResults(userScoresMap);
