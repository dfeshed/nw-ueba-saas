...
public class AggregatedFeatureEventsConfServiceTest {
    ...
    private void assertAggregatedFeatureEventConf1(AggregatedFeatureEventConf aggregatedFeatureEventConf) {
        ...
        Assert.assertEquals("HighestScore", evidencesFilterStrategy);
    ...
    private void assertAggregatedFeatureEventConf2(AggregatedFeatureEventConf aggregatedFeatureEventConf) {
        ...
        Assert.assertEquals("HighestScorePerValue", evidencesFilterStrategy);
    ...
    public void getAnomalyTypeTest() {
        Assert.assertEquals("number_of_ssh_events_hourly", aggregatedFeatureEventsConfService.getAnomalyType("name1"));
        Assert.assertEquals("number_of_ssh_events_daily", aggregatedFeatureEventsConfService.getAnomalyType("name2"));
    }
