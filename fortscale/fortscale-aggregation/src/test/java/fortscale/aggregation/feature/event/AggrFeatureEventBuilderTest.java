...
public class AggrFeatureEventBuilderTest {    
    ...
    private AggrFeatureEventBuilder createBuilder(int numberOfBuckets, int bucketLeap) throws Exception{
        ...
        AggregatedFeatureEventConf eventConf = new AggregatedFeatureEventConf("my_number_of_distinct_values", "F", "bc1", numberOfBuckets , bucketLeap, 0, "AnomalyAggregatedEvent", anyString(), paramters2featuresListMap, funcJSONObj );
