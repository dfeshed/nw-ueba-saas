 ...
 * Date: 05/08/2015
 */
public class SupportingInformationHeatMapPopulator implements SupportingInformationPopulator {

    private static Logger logger = Logger.getLogger(SupportingInformationHeatMapPopulator.class);
    ...
    public SupportingInformationData createSupportingInformationData(List<FeatureBucket> featureBuckets, String featureName, String anomalyValue, String aggregationFunction) {
        ...
        if ("countByHoursAndDays".equals(aggregationFunction)) {
