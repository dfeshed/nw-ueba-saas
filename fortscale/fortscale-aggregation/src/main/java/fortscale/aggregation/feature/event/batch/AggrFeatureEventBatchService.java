...
public class AggrFeatureEventBatchService {
    ...
    private void sendEvent(IAggregationEventSender sender, AggregatedFeatureEventConf conf, Map<String, String> context, Feature feature, Long startTimeSec, Long endTimeSec){
        if(sender != null) {
