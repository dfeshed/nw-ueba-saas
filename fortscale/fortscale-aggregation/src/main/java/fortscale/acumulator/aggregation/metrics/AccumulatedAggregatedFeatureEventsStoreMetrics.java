...
/**
 * Monitors CRUD operations of {@link AccumulatedAggregatedFeatureEventStoreImpl}
...
public class AccumulatedAggregatedFeatureEventsStoreMetrics extends StatsMetricsGroup {
     ...
     */
    public AccumulatedAggregatedFeatureEventsStoreMetrics(StatsService statsService, String featureName) {
        super(statsService, AccumulatedAggregatedFeatureEventStoreImpl.class,
