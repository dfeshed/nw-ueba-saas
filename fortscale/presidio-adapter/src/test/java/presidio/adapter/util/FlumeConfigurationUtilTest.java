...
public class FlumeConfigurationUtilTest {
    ...
    public void createSchemaPrefix() throws Exception {
        final String schemaPrefix = mockFlumeConfigurationUtil.createSchemaPrefix(Schema.ACTIVE_DIRECTORY);
        Assert.assertEquals("Schema prefix is invalid", "active_directory", schemaPrefix);
    }

    @Test
    public void getFlumeHome() throws Exception {
        final String flumeHome = mockFlumeConfigurationUtil.getFlumeHome();
    ...
    public void createConfFileName() throws Exception {
        final String confFileName = mockFlumeConfigurationUtil.createConfFileName(Schema.ACTIVE_DIRECTORY);
    ...
    public void createAgentName() throws Exception {
        final String agentName = mockFlumeConfigurationUtil.createAgentName(Schema.ACTIVE_DIRECTORY);
    ...
    public void getConfFilePathArgument() throws Exception {
        final String confFilePathArgument = mockFlumeConfigurationUtil.getConfFilePathArgument(Schema.ACTIVE_DIRECTORY);
    ...
    public void getExecuteAgentCommand() throws Exception {
        final String executeAgentCommand = mockFlumeConfigurationUtil.getExecuteAgentCommand();
    ...
    public void getAgentNameArgument() throws Exception {
        final String agentNameArgument = mockFlumeConfigurationUtil.getAgentNameArgument(Schema.ACTIVE_DIRECTORY);
    ...
    public void getFlumeExecutionScriptPath() throws Exception {
        final String flumeExecutionScriptPath = mockFlumeConfigurationUtil.getFlumeExecutionScriptPath();
