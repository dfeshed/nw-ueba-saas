...
//        int indexOfKey = 0;
//
//        LinuxProcFileSingleValueParser cmdLineParser = new LinuxProcFileSingleValueParser(cmdFilename,"\0"," ",new File(cmdFilename).getName());
//        LinuxProcFileKeyMultipleValueParser statParser = new LinuxProcFileKeyMultipleValueParser(statFilename,statsSeparator,new File(statFilename).getName(),indexOfKey);
