...
//        int indexOfKey = 0;
//
//        LinuxProcFileKeyMultipleValueParser parser = new LinuxProcFileKeyMultipleValueParser(statFilename,diskStatsSeparator,new File(statFilename).getName(),indexOfKey);
