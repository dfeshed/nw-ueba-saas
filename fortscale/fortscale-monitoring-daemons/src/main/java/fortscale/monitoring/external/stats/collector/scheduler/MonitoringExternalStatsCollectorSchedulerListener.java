 ...
 * 21/03/2016
 */
class MonitoringExternalStatsCollectorSchedulerListener extends SchedulerListenerSupport {
    private static final Logger logger = LoggerFactory.getLogger(MonitoringExternalStatsCollectorSchedulerListener.class);
    private static final int JOB_POLLING_INTERVAL_TIME = 5000; // 5 seconds

    private ClassPathXmlApplicationContext context;
    private Scheduler scheduler;

    MonitoringExternalStatsCollectorSchedulerListener(Scheduler scheduler, ClassPathXmlApplicationContext context) {
