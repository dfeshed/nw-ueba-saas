...
public class KeyValueStorageMetricsToStatsConverter extends BaseSamzaMetricsToStatsConverter {
    ...
    Map<String, KeyValueStorageMetrics> metricsMap;
        ...
        for (Map.Entry<String, Object> entry : metricEntries.entrySet()) {
            try {
                ...
                if (metricsMap.get(metricsKey) == null) {
                    KeyValueStorageMetrics newMetrics = new KeyValueStorageMetrics(statsService, jobName, storeName);
                ...
                if (operation.equals(operations.GETS.value())) {
                    ...
                    metricsMap.get(metricsKey).setMessagesRestored(entryValue);
                } else if (operation.equals(operations.RESTORED_BYTES.value())) {
                    metricsMap.get(metricsKey).setRestoredBytes(entryValue);
