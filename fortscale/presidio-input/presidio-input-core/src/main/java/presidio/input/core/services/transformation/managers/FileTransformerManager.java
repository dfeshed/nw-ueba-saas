...
public class FileTransformerManager implements TransformationManager {
    ...
    public List<Transformer> getTransformers() {
        if (transformers == null) {
            ...
            transformers.add(new OperationTypeFolderPathTransformer(FileRawEvent.SRC_FILE_PATH_FIELD_NAME, FileRawEvent.SRC_FILE_PATH_FIELD_NAME,
                    FileTransformedEvent.SRC_FOLDER_PATH_FIELD_NAME, FileRawEvent.OPERATION_TYPE_FIELD_NAME, folderOperations));
            transformers.add(new OperationTypeFolderPathTransformer(FileRawEvent.DST_FILE_PATH_FIELD_NAME, FileRawEvent.DST_FILE_PATH_FIELD_NAME,
