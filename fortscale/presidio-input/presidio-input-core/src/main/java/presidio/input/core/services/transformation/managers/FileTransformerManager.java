...
public class FileTransformerManager implements TransformationManager {
    ...
    public List<Transformer> getTransformers() {
        if (transformers == null) {
            ...
            transformers.add(new OperationTypeToCategoryTransformer(operationTypeToCategoryMapping.get(Schema.FILE), FileRawEvent.OPERATION_TYPE_FIELD_NAME, FileRawEvent.OPERATION_TYPE_CATEGORIES_FIELD_NAME,  FileRawEvent.OPERATION_TYPE_CATEGORIES_FIELD_NAME));
        }
        return transformers;
    }
