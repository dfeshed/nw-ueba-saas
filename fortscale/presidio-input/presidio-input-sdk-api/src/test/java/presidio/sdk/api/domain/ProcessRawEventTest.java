...
public class ProcessRawEventTest {
    ...
    private ProcessRawEvent createRawEvent() {
        ...
        return new ProcessRawEvent(Instant.now(), "eventId", "dataSource", "userId",
                "operationType", Collections.EMPTY_LIST, EventResult.SUCCESS, "userName",
                "userDisplayName", null, "resultCode", "machineId","machineName","machineOwner","srcProcessDirectory","srcProcessFileName",Collections.EMPTY_LIST,Collections.EMPTY_LIST,"srcProcessCertificateIssuer","dstProcessDirectory","dstProcessFileName",Collections.EMPTY_LIST,Collections.EMPTY_LIST,"dstProcessCertificateIssuer");
