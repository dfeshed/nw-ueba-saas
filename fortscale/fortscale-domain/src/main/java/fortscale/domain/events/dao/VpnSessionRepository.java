...
public interface VpnSessionRepository extends MongoRepository<VpnSession,String>{
	...
	public List<VpnSession> findByNormalizedUserNameAndCreatedAtEpochBetweenAndDurationExistsOrderByClosedAtEpochDesc(String normalizeUsername, Long createdAtEpochFrom, Long createdAtEpochTo, Boolean exists, PageRequest pageRequest);
}
