...
public interface VpnSessionRepository extends MongoRepository<VpnSession,String>{
	...
	public List<VpnSession> findByNormalizedUserNameAndCreatedAtEpochBetweenAndDurationExists(String normalizeUsername, Long createdAtEpochFrom, Long createdAtEpochTo, Boolean exists, PageRequest pageRequest);
}
