...
public class IseEventTest {
    ...
    public void ise_event_should_be_serialized_to_json_using_object_mapper() throws JsonProcessingException {
        ...
        Assert.assertEquals("{\"id\":null,\"createdAt\":1422189771865,\"timestampepoch\":1420963260000,\"ipaddress\":\"1.1.1.1\",\"hostname\":null,\"adHostName\":true,\"expiration\":12333000,\"macAddress\":null}", actual);
    }
