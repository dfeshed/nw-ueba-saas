...
public class DhcpEventTest {
    ...
    public void dhcp_event_should_be_serialized_to_json_using_object_mapper() throws JsonProcessingException {
        ...
        Assert.assertEquals("{\"id\":null,\"createdAt\":1422189771865,\"timestampepoch\":1420963260000,\"ipaddress\":\"1.1.1.1\",\"hostname\":null,\"eventPriority\":2,\"macAddress\":null,\"expiration\":12333000,\"action\":\"START\",\"adHostName\":true}", actual);
    }
