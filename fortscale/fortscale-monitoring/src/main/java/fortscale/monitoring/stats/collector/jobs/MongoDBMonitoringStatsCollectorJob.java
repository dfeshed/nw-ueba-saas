...
public class MongoDBMonitoringStatsCollectorJob extends MonitoringStatsCollectorJob {

    private static Logger logger = LoggerFactory.getLogger(MongoDBMonitoringStatsCollectorJob.class);
