...
public class SmartRecordConfServiceTest {
    ...
    private void assertFirstSmartRecordConf(SmartRecordConf smartRecordConf) {
        ...
        assertTrue(smartRecordConf.isIncludeAllAggregationRecords());
    ...
    private void assertSecondSmartRecordConf(SmartRecordConf smartRecordConf) {
        ...
        assertFalse(smartRecordConf.isIncludeAllAggregationRecords());
    ...
    private void assertThirdSmartRecordConf(SmartRecordConf smartRecordConf) {
        ...
        trees.forEach(tree -> isTreeValid(tree.getRoot()));
    }
    ...
    private void isTreeValid(TreeNode<CorrelationNodeData> node) {
        ...
        children.forEach(this::isTreeValid);
    }
