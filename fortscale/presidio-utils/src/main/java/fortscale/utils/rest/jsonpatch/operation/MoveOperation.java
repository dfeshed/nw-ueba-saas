...
public final class MoveOperation
        extends fortscale.utils.rest.jsonpatch.operation.DualPathOperation {
    @JsonCreator
    ...
    public JsonNode apply(final JsonNode node)
        ...
        final JsonPatchOperation remove = new fortscale.utils.rest.jsonpatch.operation.RemoveOperation(from, null);
