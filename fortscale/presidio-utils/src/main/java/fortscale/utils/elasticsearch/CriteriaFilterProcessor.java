...
class CriteriaFilterProcessor {
    ...
    private List<QueryBuilder> createFilterFragmentForCriteria(Criteria chainedCriteria) {
        Iterator<CriteriaEntry> it = chainedCriteria.getFilterCriteriaEntries().iterator();
...
//        }
    ...
    private List<QueryBuilder> buildNegationFilter(String fieldName, Iterator<CriteriaEntry> it) {
