...
public class ConsoleSendMessageToKafka {
    ...
    public static void main(String[] args) {
		...
		[cloudera@dev-rotemn target]$ cd /home/cloudera/fortscale/fortscale-core/fortscale/presidio-utils/target
		[cloudera@dev-rotemn target]$ java -cp presidio-utils-1.1.0-SNAPSHOT.jar:lib/* fortscale.utils.kafka.ConsoleSendMessageToKafka fortscale-normalized-tagged-event-vpn 0 "{ \"name\": \"user1\",  \"time\": 1 }"
