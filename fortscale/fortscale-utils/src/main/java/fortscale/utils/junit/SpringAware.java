 ...
 *     }</pre>
 * <p>
 * It is important to use {@link SpringAware} as class and as instance rule
  ...
  protected void starting(final Description description) {
    try {
      if (description.isSuite()) {
        ...
        TEST_METHOD.set(description.getTestClass().getMethod(description.getMethodName().substring(0, description.getMethodName().indexOf('['))));
//        TEST_METHOD.set(description.getTestClass().getMethod("beans_should_have_been_injected"));
