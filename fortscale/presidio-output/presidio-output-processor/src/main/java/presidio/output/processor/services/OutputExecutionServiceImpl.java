...
public class OutputExecutionServiceImpl implements PresidioExecutionService {
    ...
    public void run(PresidioSchemas presidioSchemas, Instant startDate, Instant endDate, Double fixedDuration) throws Exception {
        logger.debug("Started output process with params: data source:{}, from {}:{}, until {}:{}.", presidioSchemas, CommonStrings.COMMAND_LINE_START_DATE_FIELD_NAME, startDate, CommonStrings.COMMAND_LINE_END_DATE_FIELD_NAME, endDate);
