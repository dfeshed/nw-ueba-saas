...
public class AlertServiceTest {
    ...
    public void generateAlertWithOnlyStaticIndicatorsTest() {
        ...
        EnrichedEvent activeDirectoryEvent = new ActiveDirectoryEnrichedEvent(Instant.now(), eventTime,
                "eventId" + "_only_static", Schema.ACTIVE_DIRECTORY.toString(), "userId", "username", "userDisplayName",
                "dataSource", "USER_ACCOUNT_TYPE_CHANGED", new ArrayList<>(), EventResult.SUCCESS, "resultCode",
        ...
        AdeScoredEnrichedRecord activeDirectoryScoredEnrichedEvent = new AdeScoredActiveDirectoryRecord(activeDirectoryEvent.getEventDate(), "startInstant.userId.file.score", "file", 10.0d, new ArrayList<>(), activeDirectoryEnrichedRecord);
    ...
    public void generateAlertWithNotOnlyStaticIndicatorsTest() {
        ...
        // indicator
        AdeAggregationRecord notStaticAggregationRecord = new AdeAggregationRecord(startDate, endDate,
                "highestStartInstantScoreUserIdFileHourly", +10d, "startInstantHistogramUserIdFileDaily",
                Collections.singletonMap("userId", "userId"), AggregatedFeatureType.SCORE_AGGREGATION);
        // raw event
        EnrichedEvent fileEvent = new FileEnrichedEvent(Instant.now(), eventTime, "eventId", Schema.FILE.toString(),
                "userId", "username", "userDisplayName", "dataSource", "USER_ACCOUNT_TYPE_CHANGED", new ArrayList<>(),
    ...
    public void testSingleIndicatorsWithMultipleEventsTest() {
        ...
        // indicator
        AdeAggregationRecord aggregationRecord = new AdeAggregationRecord(startDate, endDate,
                "sumOfHighestSrcMachineNameRegexClusterScoresUserIdAuthenticationHourly", +10d,
                "srcMachineNameRegexClusterHistogramUserIdAuthenticationDaily",
                Collections.singletonMap("userId", "userId"), AggregatedFeatureType.SCORE_AGGREGATION);
        SmartAggregationRecord smartAggregationRecord = new SmartAggregationRecord(aggregationRecord);
        smartAggregationRecord.setContribution(0.3);
        smart.setSmartAggregationRecords(Collections.singletonList(smartAggregationRecord));
    ...
    public void testIndicatorWithMultipleAnomalyFilters() {
        ...
        // indicator
        AdeAggregationRecord aggregationRecord = new AdeAggregationRecord(startDate, endDate,
                "sumOfHighestOperationTypeScoresUserIdGroupMembershipSecuritySensitiveActiveDirectoryHourly", +10d,
                "srcMachineNameRegexClusterHistogramUserIdAuthenticationDaily",
                Collections.singletonMap("userId", "userId"), AggregatedFeatureType.SCORE_AGGREGATION);
        SmartAggregationRecord smartAggregationRecord = new SmartAggregationRecord(aggregationRecord);
        smartAggregationRecord.setContribution(0.3);
    ...
    public void testAlertWithFailureStatusEvent() {
        ...
        AdeAggregationRecord aggregationRecord = new ScoredFeatureAggregationRecord(90.0, new ArrayList<>(), startDate,
                endDate, "numberOfFailedFilePermissionChangesUserIdFileHourly", +10d,
                "numberOfFailedFilePermissionChangesUserIdFileHourly", Collections.singletonMap("userId", "userId"),
                AggregatedFeatureType.FEATURE_AGGREGATION);
        // raw event
        EnrichedEvent fileEvent1 = new FileEnrichedEvent(Instant.now(), startDate.plus(5, ChronoUnit.MINUTES),
                "eventId1", Schema.FILE.toString(), "userId", "username", "userDisplayName", "dataSource",
                "FOLDER_OWNERSHIP_CHANGED", Collections.singletonList("FILE_PERMISSION_CHANGE"), EventResult.FAILURE,
                "FAILURE", new HashMap<>(), "absoluteSrcFilePath", "absoluteDstFilePath", "absoluteSrcFolderFilePath",
                "absoluteDstFolderFilePath", 20L, true, true);
        EnrichedEvent fileEvent2 = new FileEnrichedEvent(Instant.now(), startDate.plus(10, ChronoUnit.MINUTES),
                "eventId2", Schema.FILE.toString(), "userId", "username", "userDisplayName", "dataSource",
                "FOLDER_OWNERSHIP_CHANGED", Collections.singletonList("FILE_PERMISSION_CHANGE"), EventResult.SUCCESS,
                "SUCCESS", new HashMap<>(), "absoluteSrcFilePath", "absoluteDstFilePath", "absoluteSrcFolderFilePath",
                "absoluteDstFolderFilePath", 20L, true, true);
    ...
    public void testIndicatorWithTwoCategories() {
        ...
        EnrichedEvent activeDirectoryEvent3 = new ActiveDirectoryEnrichedEvent(Instant.now(),
                ...
                Arrays.asList("GROUP_MEMBERSHIP_OPERATION", "SECURITY_SENSITIVE_OPERATION"), EventResult.SUCCESS,
                "resultCode", new HashMap<>(), "objectId");
    ...
    public void testAlertWithLargeNumberOfEvents() {
        ...
        // indicator
        AdeAggregationRecord aggregationRecord = new ScoredFeatureAggregationRecord(90.0, new ArrayList<>(), startDate,
                endDate, "numberOfFailedFilePermissionChangesUserIdFileHourly", +2000d,
                "numberOfFailedFilePermissionChangesUserIdFileHourly", Collections.singletonMap("userId", "userId"),
                AggregatedFeatureType.FEATURE_AGGREGATION);
        // raw event
        generateFileEvents(2000, aggregationRecord.getStartInstant(), "scored_enriched.file.operationType.userIdFileAction.file.score", "FOLDER_OWNERSHIP_CHANGED", Collections.singletonList("FILE_PERMISSION_CHANGE"));
        SmartAggregationRecord smartAggregationRecord = new SmartAggregationRecord(aggregationRecord);
        smartAggregationRecord.setContribution(0.3);
        smart.setSmartAggregationRecords(Collections.singletonList(smartAggregationRecord));
        Alert alert = alertService.generateAlert(smart, entity, 50);
        ...
        assertTrue(((Bucket)alert.getIndicators().get(0).getHistoricalData().getAggregation().getBuckets().get(0)).isAnomaly());
    }
    ...
    public void testAlertWithSourceMachineTransformer() {
        ...
        // indicator
        AdeAggregationRecord aggregationRecord = new ScoredFeatureAggregationRecord(90.0, new ArrayList<>(), startDate,
                endDate, "sumOfHighestSrcMachineNameRegexClusterScoresUserIdAuthenticationHourly", 100.0,
                "srcMachineNameRegexClusterHistogramUserIdAuthenticationHourly",
                Collections.singletonMap("userId", "userId"), AggregatedFeatureType.SCORE_AGGREGATION);
        // raw event
    ...
    public void testScoreIndicatorsContribution() {
        ...
        AdeAggregationRecord scoreAggregationRecord = new ScoredFeatureAggregationRecord(90.0, new ArrayList<>(),
                startDate, endDate, "sumOfHighestOperationTypeScoresUserIdFileActionFileHourly", 100.0,
                "operationTypeHistogramUserIdFileDaily", Collections.singletonMap("userId", "userId"),
                AggregatedFeatureType.SCORE_AGGREGATION);
        generateFileEvents(1, scoreAggregationRecord.getStartInstant(), "scored_enriched.file.operationType.userIdFileAction.file.score", "FOLDER_OWNERSHIP_CHANGED", Collections.singletonList("FILE_PERMISSION_CHANGE"));
        generateFileEvents(1, scoreAggregationRecord.getStartInstant(), "scored_enriched.file.operationType.userIdFileAction.file.score", "FOLDER_AUDITING_CHANGED", Collections.singletonList("FILE_PERMISSION_CHANGE"));
        // indicator2 - feature aggr
        AdeAggregationRecord featureAggregationRecord = new ScoredFeatureAggregationRecord(90.0, new ArrayList<>(),
                startDate, endDate, "numberOfFailedFilePermissionChangesUserIdFileHourly", +2000d,
                "numberOfFailedFilePermissionChangesUserIdFileHourly", Collections.singletonMap("userId", "userId"),
                AggregatedFeatureType.FEATURE_AGGREGATION);
        generateFileEvents(1, featureAggregationRecord.getStartInstant(), "scored_enriched.file.operationType.userIdFileAction.file.score", "FOLDER_OWNERSHIP_CHANGED", Collections.singletonList("FILE_PERMISSION_CHANGE"));
    ...
    public void testExceedEventsLimit() {
        ...
        AdeAggregationRecord aggregationRecord = new ScoredFeatureAggregationRecord(90.0, new ArrayList<>(), startDate,
                ...
                AggregatedFeatureType.FEATURE_AGGREGATION);
        // raw event
        generateFileEvents(102, aggregationRecord.getStartInstant(),
                "scored_enriched.file.operationType.userIdFileAction.file.score", "FOLDER_OWNERSHIP_CHANGED",
                Collections.singletonList("FILE_PERMISSION_CHANGE")); // generating 2 events more than the limit (=100)
        SmartAggregationRecord smartAggregationRecord = new SmartAggregationRecord(aggregationRecord);
        smartAggregationRecord.setContribution(0.3);
        smart.setSmartAggregationRecords(Collections.singletonList(smartAggregationRecord));
        // generate alerts
    ...
    private void generateFileEvents(int eventsNum, Instant startEventTime, String adeEventType, String operationType, List<String> operationTypeCategories) {
        ...
        for (int i = 1; i <= eventsNum; i++) {
            ...
            FileEnrichedEvent fileEvent = new FileEnrichedEvent(now,
                    startEventTime.plus(new Random().nextInt(50), ChronoUnit.MINUTES), "eventId1" + i, schema, "userId",
                    "username", "userDisplayName", "dataSource", operationType, operationTypeCategories,
            ...
            AdeScoredEnrichedRecord fileScoredEnrichedEvent = new AdeScoredFileRecord(enrichedFileRecord.getStartInstant(), adeEventType, "authentication", 10.0d, new ArrayList<>(), enrichedFileRecord);
    ...
    private void generateAuthenticationEvents(int eventsNum, Instant startEventTime, String adeEventType) {
        ...
        for (int i = 1; i <= eventsNum; i++) {
            // generate output events
            AuthenticationEnrichedEvent authenticationEvent = new AuthenticationEnrichedEvent(now,
                    startEventTime.plus(new Random().nextInt(5), ChronoUnit.MINUTES), "eventId1" + i, schema, "userId",
                    "username", "userDisplayName", "dataSource", "User authenticated through Kerberos",
                    new ArrayList<>(), EventResult.SUCCESS, "SUCCESS", new HashMap<>());
    ...
    private void generateActiveDirectoryEvents(int eventsNum, Instant startEventTime, String adeEventType, String operationType, List<String> operationTypeCategories) {
        Instant now = Instant.now();
        String schema = Schema.ACTIVE_DIRECTORY.toString();

        for (int i = 1; i <= eventsNum; i++) {
            // generate output events
            ActiveDirectoryEnrichedEvent activeDirectoryEvent = new ActiveDirectoryEnrichedEvent(now,
                    startEventTime.plus(new Random().nextInt(5), ChronoUnit.MINUTES), "eventId" + UUID.randomUUID(),
                    schema, "userId", "username", "userDisplayName", "dataSource", operationType,
                    operationTypeCategories, EventResult.SUCCESS, "SUCCESS", new HashMap<>(), "");
            mongoTemplate.save(activeDirectoryEvent, new OutputToCollectionNameTranslator().toCollectionName(Schema.ACTIVE_DIRECTORY));
            // generate ade events
            ...
            // generate scored ade events
            AdeScoredEnrichedRecord activeDirectoryScoredEnrichedEvent = new AdeScoredActiveDirectoryRecord(enrichedActiveDirectoryRecord.getStartInstant(), adeEventType, "active_directory", 10.0d, new ArrayList<>(), enrichedActiveDirectoryRecord);
    ...
    private SmartRecord generateSingleSmart(int score) {
        ...
        return new SmartRecord(timeRange, CONTEXT_ID, "featureName", FixedDurationStrategy.HOURLY, 5.0, score,
                featureScores, smartAggregationRecords, null);
    }
}
