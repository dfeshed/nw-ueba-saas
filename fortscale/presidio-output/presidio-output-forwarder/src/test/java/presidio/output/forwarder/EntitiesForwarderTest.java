...
public class EntitiesForwarderTest {
    ...
    static class ContextConfiguration {
        ...
        public EntityPersistencyService entityPersistencyService() {
            ...
            Mockito.when(entitiesPersistencyService.findEntitiesByUpdatedDateAndEntityType(Mockito.any(Instant.class), Mockito.any(Instant.class), Mockito.any(String.class))).thenReturn(Collections.singletonList(entity).stream());
