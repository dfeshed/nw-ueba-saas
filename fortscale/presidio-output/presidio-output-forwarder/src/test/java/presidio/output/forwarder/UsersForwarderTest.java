...
public class UsersForwarderTest {
    ...
    public void testUsersForwarding() {
        ...
        Assert.assertEquals("{\"id\":\"c678bb28-f795-402c-8d64-09f26e82807d\",\"entityId\":\"test\",\"severity\":\"CRITICAL\",\"alertsCount\":0}",memoryForwarder.allMessages.get(0).getPayload());
    }
