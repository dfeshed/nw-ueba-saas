...
public class IndicatorsForwarderTest {
    ...
    static class ContextConfiguration {
        ...
        public AlertPersistencyService alertPersistencyService() {
            ...
            Mockito.when(alertPersistencyService.findIndicatorByDateAndAlertIds(Mockito.any(Instant.class),Mockito.any(Instant.class), Mockito.any(List.class))).thenReturn(Collections.singletonList(indicator).stream());
    ...
    public void testAlertsForwarding() {
        indicatorsForwarder.forward(Instant.now(), Instant.now(), "entityType", Arrays.asList("c678bb28-f795-402c-8d64-09f26e82807d"));
