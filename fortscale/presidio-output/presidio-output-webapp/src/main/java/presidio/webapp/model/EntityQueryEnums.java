...
public class EntityQueryEnums {
    ...
    public enum EntityQuerySortFieldName {
        ...
        ENTITY_TYPE_NAME(Entity.ENTITY_TYPE_FIELD_NAME),WEEKLY_TRENDS(Entity.TRENDING_SCORE + "." + EntityEnums.Trends.weekly),
        DAILY_TRENDS(Entity.TRENDING_SCORE + "." + EntityEnums.Trends.daily);
