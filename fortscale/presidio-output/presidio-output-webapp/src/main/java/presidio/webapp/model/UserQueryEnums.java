...
public class UserQueryEnums {
    ...
    public enum UserQuerySortFieldName {
        SCORE(User.SCORE_FIELD_NAME), ALERT_NUM(User.ALERTS_COUNT_FIELD_NAME), USER_NAME(User.INDEXED_USER_NAME_FIELD_NAME), USER_DISPLAY_NAME(User.USER_DISPLAY_NAME_SORT_LOWERCASE_FIELD_NAME);
