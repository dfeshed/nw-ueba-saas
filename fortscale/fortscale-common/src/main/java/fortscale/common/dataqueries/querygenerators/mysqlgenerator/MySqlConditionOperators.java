...
import fortscale.common.dataqueries.querydto.QueryOperator;
import fortscale.common.dataqueries.querygenerators.exceptions.InvalidQueryException;
import fortscale.common.dataqueries.querygenerators.mysqlgenerator.operators.*;
...
public class MySqlConditionOperators {
    ...
    static{
        ...
        operatorsList.put(QueryOperator.notEquals, new MySqlOperatorsList(new ArrayList<MySqlOperator>(Arrays.asList(new MySqlOperator("!=", true),new MySqlOperator("IS NULL", false))), LogicalOperator.OR));
