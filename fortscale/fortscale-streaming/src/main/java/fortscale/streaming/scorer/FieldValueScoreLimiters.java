...
public class FieldValueScoreLimiters {
	...
	public boolean equals(Object o) {
		...
		FieldValueScoreLimiters that = (FieldValueScoreLimiters)o;
		if (limiters != null ? !limiters.equals(that.limiters) : that.limiters != null)
			return false;
	...
	@Override
	public int hashCode() {
		return limiters != null ? limiters.hashCode() : 0;
	}
	 ...
	 */
	public static final class FieldValueScoreLimiter {
