 ...
 */
public class VpnSessionEvidencePreProcess extends AbstractEvidencePreProcess implements EvidencePreProcess {
	 ...
	 * @return
	 */
	@Override public JSONObject run(JSONObject message, EvidenceCreationTask.DataSourceConfiguration dataSourceConfiguration) {
