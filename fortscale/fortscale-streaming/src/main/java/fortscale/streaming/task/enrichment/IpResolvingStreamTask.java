...
public class IpResolvingStreamTask extends AbstractStreamTask {
    ...
    protected void wrappedInit(Config config, TaskContext context) throws Exception {
        ...
        if (service==null) {
            ...
            boolean resolveOnlyReservedIp = config.getBoolean("fortscale.events.resolveOnlyReserved");
            ...
            for (String fieldConfigKey : Iterables.filter(fieldsSubset.keySet(), StringPredicates.endsWith(".input.topic"))) {
                ...
                resolveOnlyReservedIp = config.getBoolean(String.format("fortscale.events.%s.resolveOnlyReserved", eventType),resolveOnlyReservedIp);
