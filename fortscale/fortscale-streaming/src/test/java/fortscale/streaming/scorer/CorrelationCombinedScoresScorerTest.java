...
public class CorrelationCombinedScoresScorerTest extends ScorerContainerTest {
	...
	public void test_build_scorer_with_two_scores() throws Exception {
		...
		// Scores: 100, 90
		testBuildScorerWithScore1(CorrelationCombinedScoresScorerFactory.SCORER_TYPE, 98.0d);
	}
	...
	public void test_build_scorer_with_one_score() throws Exception {
		...
		// Scores: 90
		testBuildScorerWithScore2(CorrelationCombinedScoresScorerFactory.SCORER_TYPE, 63.0d);
	}

	@Test
	public void test_build_scorer_with_no_scores() throws Exception {
		highestScoreWeight = 0.8d;
		testBuildScorerWithScore3(CorrelationCombinedScoresScorerFactory.SCORER_TYPE, 0.0d);
	}
	...
	public void test_build_scorer_with_two_scores_reversed() throws Exception {
		highestScoreWeight = 0.7d;
		// Scores: 90, 100
		testBuildScorerWithScore4(CorrelationCombinedScoresScorerFactory.SCORER_TYPE, 97.0d);
	}

	@Test(expected = ConfigException.class)
	public void test_build_scorer_with_no_scorer_name() throws Exception {
		highestScoreWeight = 0.5d;
		testBuildScorerWithNoScorerName(CorrelationCombinedScoresScorerFactory.SCORER_TYPE);
	}

	@Test(expected = ConfigException.class)
	public void test_build_scorer_with_no_output_field_name() throws Exception {
		highestScoreWeight = 0.5d;
		testBuildScorerWithNonOutputFieldName(CorrelationCombinedScoresScorerFactory.SCORER_TYPE);
	}

	@Test(expected = ConfigException.class)
	public void test_build_scorer_with_blank_output_field_name() throws Exception {
		highestScoreWeight = 0.5d;
		testBuildScorerWithBlankOutputFieldName(CorrelationCombinedScoresScorerFactory.SCORER_TYPE);
	}

	@Test(expected = ConfigException.class)
	public void test_build_scorer_with_no_scorers() throws Exception {
		highestScoreWeight = 0.5d;
		testBuildScorerWithNonScorers(CorrelationCombinedScoresScorerFactory.SCORER_TYPE);
	}

	@Test(expected = ConfigException.class)
	public void test_build_scorer_with_blank_scorers() throws Exception {
		highestScoreWeight = 0.5d;
		testBuildScorerWithBlankScorers(CorrelationCombinedScoresScorerFactory.SCORER_TYPE);
	}

	@Test(expected = ConfigException.class)
	public void test_build_scorer_with_invalid_highest_score_weight() throws Exception {
		highestScoreWeight = -0.5d;
		buildScorer(CorrelationCombinedScoresScorerFactory.SCORER_TYPE, SCORER_NAME, OUTPUT_FIELD_NAME, configScorers());
	}
}
