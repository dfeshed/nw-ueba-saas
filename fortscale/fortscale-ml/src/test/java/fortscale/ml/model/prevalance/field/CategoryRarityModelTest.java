...
public class CategoryRarityModelTest extends AbstractModelTest {
	...
	private class CategoryRarityScenarioCallbacks implements ScenarioCallbacks {
		...
		public Double onScore(TestEventsBatch eventsBatch) {
			...
			return calcScore(1, maxRareCount, maxNumOfRareFeatures, featureValueToCountMap, eventFeatureCount + 1);
		}
