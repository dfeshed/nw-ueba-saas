...
public class ScoreMappingfTest {
    ...
    public void shouldFailIfSettingNullInTheConf() {
        new ScoreMapping.ScoreMappingConf().setMapping(null);
    }
    ...
    public void shouldAdd0And100MappingPointsToTheConfWhenSettingMapping() {
        ...
        ScoreMapping.ScoreMappingConf conf = new ScoreMapping.ScoreMappingConf().setMapping(mapping);
    ...
    public void shouldFailSettingNonMonotonicMappingInTheConf() {
        ...
        mapping.put(0D, 10D);
        mapping.put(100D, 9D);
        new ScoreMapping.ScoreMappingConf().setMapping(mapping);
    }
}
