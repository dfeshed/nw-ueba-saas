...
public class ApiEvidenceControllerTest {
	...
	public void setUp() throws Exception {
		...
		when(supportingInformationService.getEvidenceSupportingInformationData(eq(mockEvidence), anyString(), anyString(), anyString(), anyLong(), anyInt(), eq("Count"))).thenReturn(new SupportingInformationData(countries, anomalyCountry));
	...
	public void testHistoricalDataDualKey() throws Exception{
		...
		when(supportingInformationService.getEvidenceSupportingInformationData(eq(mockEvidence), anyString(), anyString(), anyString(), anyLong(), anyInt(), eq("hourlyCountGroupByDayOfWeek"))).thenReturn(new SupportingInformationData(heatmap, anomalyTime));
