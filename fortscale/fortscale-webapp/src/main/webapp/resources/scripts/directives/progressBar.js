...
angular.module('Fortscale')
    .directive('progressBar', function ($timeout, reports, transforms) {
        return {
            template: "<div class='progress-bar' ng-style='{width: width}' title='{{tooltip}}'><span ng-style='{width: progressValue, background: progressColor}'><em ng-show='showArrow'></em></span></div>",
            restrict: 'E',
            replace: true,
            require: "?ngModel",
