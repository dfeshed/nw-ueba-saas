...
public class MetricEnums {
    ...
    public enum MetricValues {
        ...
        SYSTEM_PROCESSORS("processors"),
        SYSTEM_UPTIME("uptime"),
        SYSTEM_SYSTEMLOAD_AVERAGE("systemload.average"),
    ...
    public enum MetricTagKeysEnum {
        HOST, SCHEMA, UNIT, RESULT, APPLICATION_NAME, PID, IS_SYSTEM_METRIC,ADE_EVENT_TYPE,SCORER,MODEL,FAILURE_REASON, FEATURE_NAME, AGGREGATED_FEATURE_TYPE,GROUP_NAME, TIME, FEATURE_BUCKET,FLUME_COMPONENT_TYPE,FLUME_COMPONENT_INSTANCE_ID, GC_YOUNG_COLLECTOR, GC_OLD_COLLECTOR;
    }
