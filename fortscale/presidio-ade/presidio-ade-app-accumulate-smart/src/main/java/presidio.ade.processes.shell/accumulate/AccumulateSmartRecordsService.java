...
public class AccumulateSmartRecordsService extends AccumulationStrategyExecutor {
    ...
    protected void executeSingleTimeRange(TimeRange timeRange, String configurationName, StoreManagerMetadataProperties storeManagerMetadataProperties) {
        ...
        for (PageIterator<SmartRecord> pageIterator : pageIterators) {
            ...
            smartAccumulationDataStore.store(accumulationsRecords, configurationName, storeManagerMetadataProperties);
        }
    }
