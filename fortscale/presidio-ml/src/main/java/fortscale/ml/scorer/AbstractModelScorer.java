...
public abstract class AbstractModelScorer extends AbstractScorer {
    ...
    Model getModel(AdeRecordReader adeRecordReader) {
    ...
    protected double calculateCertainty(Model model) {
        ...
        if (numOfSamples >= enoughNumOfSamplesToInfluence) {
            ...
            certainty = ((double)(numOfSamples - minNumOfSamplesToInfluence + 1)) /
                    (enoughNumOfSamplesToInfluence - minNumOfSamplesToInfluence + 1);
        }
