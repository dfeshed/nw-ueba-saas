...
@JsonSubTypes({
		...
		@JsonSubTypes.Type(value = ContextSequentialReducedHistogramRetrieverConf.class, name = ContextSequentialReducedHistogramRetrieverConf.CONTEXT_HISTOGRAM_SEQUENTIAL_REDUCED_RETRIEVER),
