...
public class SMARTMaxValuesModelScorerTest {
    @Configuration
    ...
    private SMARTMaxValuesModelScorer createScorer(String globalModelName, int globalInfluence, double baseScore, Instant modelEndTime) throws Exception {
        ...
        int maxUserInfluence = 10;
        int numOfPartitionUserInfluence = 5;
        int minNumOfUserValues = 5;
    ...
    public void shouldFailToScoreIfGivenWrongModelType() throws Exception {
        ...
        SMARTMaxValuesModelScorer scorer = createScorer("additional model name", 0, 50D, modelEndTime);
