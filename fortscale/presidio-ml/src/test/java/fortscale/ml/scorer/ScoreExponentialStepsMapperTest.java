...
public class ScoreExponentialStepsMapperTest {
    ...
    public void test_score_with_exponential_mapping_default_configuration() throws Exception {
        ...
        double expectedScore = scoreMappingConf.MIN_MAPPED_SCORE_DEFAULT;
        double score = 0.9544;
    ...
    public void test_score_with_different_sd() throws Exception {
        ...
        Assert.assertEquals(0.09647616625079776, mappedScore, 0.0);
        //3sd
        mappedScore = calcScore(99.73, scoreMappingConf);
        Assert.assertEquals(27.885980698699914, mappedScore, 0.0);
        //3.5sd
        mappedScore = calcScore(99.95, scoreMappingConf);
        Assert.assertEquals(44.5919987297633, mappedScore, 0.0);
        //4sd
        mappedScore = calcScore(99.99, scoreMappingConf);
        Assert.assertEquals(60.45093608231918, mappedScore, 0.0);
        //4.5sd
        mappedScore = calcScore(99.999, scoreMappingConf);
        Assert.assertEquals(83.23008551768244, mappedScore, 0.0);
        //5sd
