...
public class StringConditionalScorerConfTest {
    ...
    public void should_deserialize_conditional_scorer_conf_from_json() throws IOException {
        ...
        JSONObject jsonObject = getConditionalScorerConfJsonObject(
                StringConditionalScorerConf.SCORER_TYPE, name, defaultScorerConfJsonObject, conditionalField, conditionalValue);
        IScorerConf scorerConf = getScorerConf(jsonObject);

        Assert.assertEquals(StringConditionalScorerConf.class, scorerConf.getClass());
        Assert.assertEquals(name, scorerConf.getName());
        Assert.assertEquals(getScorerConf(defaultScorerConfJsonObject), ((StringConditionalScorerConf)scorerConf).getScorer());
        Assert.assertEquals(conditionalField, ((StringConditionalScorerConf)scorerConf).getConditionalField());
        Assert.assertEquals(conditionalValue, ((StringConditionalScorerConf)scorerConf).getConditionalValue());
    }
    ...
    public void should_fail_when_name_is_null() throws IOException {
        String conditionalField = "myConditionalField";
        String conditionalValue = "some-conditional-value";
        JSONObject jsonObject = getConditionalScorerConfJsonObject(StringConditionalScorerConf.SCORER_TYPE, null, defaultScorerConfJsonObject, conditionalField, conditionalValue);
    ...
    public void should_fail_when_name_is_empty() throws IOException {
        ...
        String conditionalValue = "some-conditional-value";
        JSONObject jsonObject = getConditionalScorerConfJsonObject(
                StringConditionalScorerConf.SCORER_TYPE, "", defaultScorerConfJsonObject, conditionalField, conditionalValue);
        getScorerConf(jsonObject);
    }
    ...
    public void should_fail_when_name_is_blank() throws IOException {
        String conditionalField = "myConditionalField";
        String conditionalValue = "some-conditional-value";
        JSONObject jsonObject = getConditionalScorerConfJsonObject(StringConditionalScorerConf.SCORER_TYPE, "   ", defaultScorerConfJsonObject, conditionalField, conditionalValue);
        getScorerConf(jsonObject);
    }
    ...
    public void should_fail_when_scorer_conf_is_null() throws IOException {
        ...
        String conditionalField = "myConditionalField";
        String conditionalValue = "some-conditional-value";
        JSONObject jsonObject = getConditionalScorerConfJsonObject(StringConditionalScorerConf.SCORER_TYPE, name, null, conditionalField, conditionalValue);
        getScorerConf(jsonObject);
    }
