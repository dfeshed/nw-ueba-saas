package presidio.integration.performance.generators.active_directory;

import presidio.data.domain.event.OperationType;
import presidio.data.generators.common.*;
import presidio.data.generators.common.time.MultiRangeTimeGenerator;
import presidio.data.generators.event.OPERATION_RESULT;
import presidio.data.generators.event.performance.active_directory.ActiveDirectoryUseCaseEventGeneratorsBuilder;
