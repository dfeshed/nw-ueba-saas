...
public class AggrFeatureEventNumberOfNewOccurrencesFuncTest {
    ...
    public void testCalculateAggrFeature() {
        ...
        MultiKeyFeature multiKeyFeatureNewOccurrence = new MultiKeyFeature();
        multiKeyFeatureNewOccurrence.add("newOccurrenceFeatureName", "newOccurrenceFeatureValue");
        histogram2.set(multiKeyFeatureNewOccurrence, 4.0);
        @SuppressWarnings("unchecked")
