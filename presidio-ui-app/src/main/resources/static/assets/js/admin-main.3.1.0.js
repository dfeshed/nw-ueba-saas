(function () {
    ...
    angular.module("FortscaleAuth", ["Utils"]).factory("auth", ["$q", "$http", "utils", "configFlags",
        function ($q, $http, utils, configFlags) {
            var apiUrl = "api/analyst/", adminApiUrl = "api/admin/";
...
(function () {
    'use strict';
    angular.module("FortscaleAdmin", ["FortscaleAuth"]).run(function ($rootScope) {
    ...
    angular.module("FortscaleAdmin").controller("AdminController", ["$scope", "auth", function ($scope, auth) {
            ...
            $scope.renewPasswordModal = {
                ...
                update: function () {
                    ...
                    auth.renewPassword($scope.renewPasswordModal.renewPasswordUser.userName, $scope.renewPasswordModal.adminPassword, $scope.renewPasswordModal.newPassword)
                        .then(function () {
                        $scope.renewPasswordModal.error = null;
...
//# sourceMappingURL=admin-main.3.1.0.js.map
