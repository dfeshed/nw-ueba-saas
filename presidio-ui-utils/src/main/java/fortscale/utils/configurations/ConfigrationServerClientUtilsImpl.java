 ...
 */
public class ConfigrationServerClientUtilsImpl implements ConfigrationServerClientUtils {
    ...
    public ConfigrationServerClientUtilsImpl(RestTemplate restTemplate, String serverUrl, String serverUserName, String serverUserNamePassword) {
    ...
    private static class ConfigurationServcerClientSettings{
