...
public class AbnormalTrafficNew<T> {
    ...
    public AbnormalTrafficNew(String entity, EntityType type, String name, int dataPeriod, int uncommonStartDay) {
        this.entity = entity;
    ...
    public TlsRangeEventsGen createNormalTrafficHistoryGen(TlsRangeEventsGen initialGenCopy, FieldRangeAllocator<T> destinationGen){
        ...
        eventsSupplier.setCommonValuesGenForNewOccurrences(initialGenCopy, 60);
