...
import com.rsa.netwitness.presidio.automation.converter.formatters.AwsFormatter;
...
public class EventsProducerSupplier {
    ...
    public EventsProducerSupplier(NetwitnessEventStore netwitnessEventStore) {
        ...
        producers.putIfAbsent(S3_JSON_GZIP_CHUNKS, () -> new S3JsonGzipChunksProducer(new JsonLineFormatter<>(new AwsFormatter())));
        producers.putIfAbsent(S3_JSON_GZIP, () -> new S3JsonGzipProducer(new JsonLineFormatter<>(new AwsFormatter())));
