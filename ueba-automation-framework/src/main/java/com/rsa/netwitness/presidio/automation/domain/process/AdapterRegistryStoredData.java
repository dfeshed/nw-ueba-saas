...
@Document(collection = "input_registry_raw_events")
public class AdapterRegistryStoredData extends Event {
    ...
    private AdapterRegistryStoredData(){
    }

    private AdapterRegistryStoredData(Builder builder) {
        this.id = builder.id;
    ...
    public static class Builder {
        ...
        public AdapterRegistryStoredData build() {
            return new AdapterRegistryStoredData(this);
        }
    }
}
