...
class HourlyCefFileProducer extends CefFilesPrinter implements EventsProducer<List<NetwitnessEvent>> {

    HourlyCefFileProducer(EventFormatter<String> formatter) {
        super(formatter);
    }
