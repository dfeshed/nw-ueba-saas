...
export default {
  ...
  totalCount: '/presidio/api/entity/count?',
  userOverview: '/presidio/api/entity?min_score=0&size=10&sort_direction=DESC&',
  alertOverview: '/presidio/api/alerts?isOverview=true&page=1&size=12&sort_direction=DESC&sort_field=score&status=open&',
