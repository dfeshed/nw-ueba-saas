package com.rsa.netwitness.presidio.automation.domain.registry;
...
@Document(collection = "output_registry_enriched_events")
public class OutputRegistryEnrichedStoredData {
