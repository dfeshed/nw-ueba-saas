package presidio.integration.performance.generators.authentication;
...
import presidio.data.generators.event.performance.authentication.AuthenticationUseCaseEventGeneratorsBuilder;
...
public class FailureInteractiveAuthenticationUseCaseEventGeneratorsBuilder extends AuthenticationUseCaseEventGeneratorsBuilder {
    ...
    public FailureInteractiveAuthenticationUseCaseEventGeneratorsBuilder
    ...
    protected String getUseCaseTestName() {
        return "failedInteractiveAuthentication";
    }
}
