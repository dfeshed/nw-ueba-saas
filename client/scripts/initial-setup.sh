...
# source in NVM so it can be used right away once script is done
# TMP_SOURCE_NVM=tmp-source-nvm.sh
# cat > $TMP_SOURCE_NVM << END_OF_FILE_END_OF_FILE
# export NVM_DIR="/Users/bashfd/.nvm"
# . "/Users/bashfd/.nvm/nvm.sh"
# END_OF_FILE_END_OF_FILE
# source $TMP_SOURCE_NVM
# rm $TMP_SOURCE_NVM
