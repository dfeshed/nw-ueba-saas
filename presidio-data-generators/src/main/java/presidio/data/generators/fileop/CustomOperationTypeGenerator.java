...
public class CustomOperationTypeGenerator extends CyclicValuesGenerator<OperationType> implements IOperationTypeGenerator {

    String[] customOpTypesDefault = new String[] {
            "LOCAL_SHARE_REMOVED",
            "LOCAL_SHARE_PERMISSIONS_CHANGED",
            "LOCAL_SHARE_FOLDER_PATH_CHANGED",
            "LOCAL_SHARE_ADDED",
            "JUNCTION_POINT_DELETED",
            "JUNCTION_POINT_CREATED",
            "FOLDER_RENAMED",
            ...
            "FAILED_FILE_ACCESS",
            "NET_APP_FOLDER_RENAMED",
            "NET_APP_FOLDER_OWNERSHIP_CHANGED",
            "NET_APP_FOLDER_MOVED",
            "NET_APP_FOLDER_DELETED",
            "NET_APP_FOLDER_CREATED",
            "NET_APP_FOLDER_ACCESS_RIGHTS_CHANGED",
            "NET_APP_FILE_RENAMED",
            "NET_APP_FILE_OWNERSHIP_CHANGED",
            "NET_APP_FILE_OPENED",
            "NET_APP_FILE_MOVED",
            "NET_APP_FILE_DELETED",
            "NET_APP_FILE_CREATED",
            "NET_APP_FILE_ACCESS_RIGHTS_CHANGED",
            "EMC_FOLDER_RENAMED",
            "EMC_FOLDER_OWNERSHIP_CHANGED",
            "EMC_FOLDER_MOVED",
            "EMC_FOLDER_DELETED",
            "EMC_FOLDER_CREATED",
            "EMC_FOLDER_ACCESS_RIGHTS_CHANGED",
            "EMC_FILE_RENAMED",
            "EMC_FILE_OWNERSHIP_CHANGED",
            "EMC_FILE_OPENED",
            "EMC_FILE_MOVED",
            "EMC_FILE_DELETED",
            "EMC_FILE_CREATED",
            "EMC_FILE_ACCESS_RIGHTS_CHANGED",
            "CEPP_CONFIGURATION_CHANGED",
            "FLUIDFS_FOLDER_RENAMED",
            "FLUIDFS_FOLDER_OWNERSHIP_CHANGED",
    ...
    public CustomOperationTypeGenerator(String[] operationTypeNames)
    {
        super();
