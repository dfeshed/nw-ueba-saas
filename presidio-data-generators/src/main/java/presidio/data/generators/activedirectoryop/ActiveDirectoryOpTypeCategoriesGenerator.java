...
public class ActiveDirectoryOpTypeCategoriesGenerator implements IStringListGenerator {
    private static final String[] ALL_ACTIVEDIRECTORY_OP_TYPE_CATEGORIES = {
            ...
            ACTIVEDIRECTORY_OP_TYPE_CATEGORIES.GROUP_MEMBERSHIP_ADD_OPERATION.value,
            ACTIVEDIRECTORY_OP_TYPE_CATEGORIES.GROUP_MEMBERSHIP_REMOVE_OPERATION.value,
            ACTIVEDIRECTORY_OP_TYPE_CATEGORIES.OBJECT_MANAGEMENT.value,
            ACTIVEDIRECTORY_OP_TYPE_CATEGORIES.USER_MANAGEMENT.value
    };
