...
public class TlsEventsSimplePerfGen extends AbstractEventGenerator<TlsEvent> {
    ...
    public static final int NUM_OF_JA3 = 1710;
    public static final int NUM_OF_DOMAINS = 15000;
    public static final int NUM_OF_COUNTRIES = 40;
    public static final int NUM_OF_DST_ORG = 2000;
    public static final int NUM_OF_SRC_IPS = 2000;  // ??
    ...
    private Supplier<Boolean> isAnomaly;
    ...
    public TlsEventsSimplePerfGen(TlsPerfClusterParams params) {
        ...
        random = new Random(UNIQUE_ID);
        isAnomaly = () -> random.nextDouble() <= params.getAlertsProbability();
    ...
    public TlsEvent generateNext() throws GeneratorException {
        ...
        tlsEvent.setDstIp(nextSslSubjectEntityGen.getDstIpGen().getNext());
        ...
        tlsEvent.setNumOfBytesSent(isAnomaly.get() ? unusualTrafficGenerator.getNext() : numOfBytesSentGenerator.getNext());
