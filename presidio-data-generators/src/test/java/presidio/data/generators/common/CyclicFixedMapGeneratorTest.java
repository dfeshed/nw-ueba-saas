 ...
 */
public class CyclicFixedMapGeneratorTest {
    @Test
    public void testFixedMapGenerator() {
        ...
        CyclicFixedMapGenerator<Integer,Double> cyclicFixedMapGenerator = new CyclicFixedMapGenerator<Integer,Double>(fixedMaps);

        Assert.assertEquals(fixedMap1, cyclicFixedMapGenerator.getNext());
        Assert.assertEquals(fixedMap2, cyclicFixedMapGenerator.getNext());
        Assert.assertEquals(fixedMap1, cyclicFixedMapGenerator.getNext());
