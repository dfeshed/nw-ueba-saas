...
public class SuccessfulFilePermissionEventGeneratorsBuilder extends FileUseCaseEventGeneratorsBuilder{
    ...
    public SuccessfulFilePermissionEventGeneratorsBuilder(IUserGenerator normalUserGenerator,
    ...
    private List<OperationType> getOperationTypesPool(){
        if(operationTypesPool == null){
            operationTypesPool = getAllOperationTypes(FILE_OPERATION_TYPE_CATEGORIES.FILE_PERMISSION_CHANGE);
        }
    ...
    protected String getUseCaseTestName() {
        return "SuccessfulFilePermissionEvent";
    }
