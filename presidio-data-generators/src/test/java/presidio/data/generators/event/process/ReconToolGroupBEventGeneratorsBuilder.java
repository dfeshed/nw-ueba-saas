...
public class ReconToolGroupBEventGeneratorsBuilder extends UseCaseEventGeneratorsBuilder{
    ...
    private final int RECON_TOOL_GROUP_B_NUM_OF_NORMAL_USERS = 1;
    private final int RECON_TOOL_GROUP_B_NUM_OF_NORMAL_USERS_DAILY = 1;
    private final double RECON_TOOL_GROUP_B_PROBABILITY_NORMAL_USER = 0; // Not relevant for normal users
    private final int RECON_TOOL_GROUP_B_TIME_INTERVAL_FOR_ABNORMAL_TIME_FOR_NORMAL_USERS = 3600000;
    ...
    private final int RECON_TOOL_GROUP_B_NUM_OF_ADMIN_USERS = 750;
    private final int RECON_TOOL_GROUP_B_NUM_OF_ADMIN_USERS_DAILY = 75;
    private final double RECON_TOOL_GROUP_B_PROBABILITY_ADMIN_USER = 0.01; // ~480 events per hour per user
    private final int RECON_TOOL_GROUP_B_TIME_INTERVAL_FOR_ABNORMAL_TIME_FOR_ADMIN_USERS = 50000; //50 seconds. (2*3600/50)*0.1 =~15 users
    ...
    private final int RECON_TOOL_GROUP_B_NUM_OF_SERVICE_ACCOUNT_USERS = 1;
    private final int RECON_TOOL_GROUP_B_NUM_OF_SERVICE_ACCOUNT_USERS_DAILY = 1;
    private final double RECON_TOOL_GROUP_B_PROBABILITY_SERVICE_ACCOUNT_USER = 0; // Not relevant to service accounts
    ...
    private final int ABNORMAL_RECON_TOOL_GROUP_B_NUM_OF_NORMAL_USERS_DAILY = 1;
    private final double ABNORMAL_RECON_TOOL_GROUP_B_PROBABILITY_NORMAL_USER = 0; // Not relevant for normal users
    ...
    private final int ABNORMAL_RECON_TOOL_GROUP_B_NUM_OF_ADMIN_USERS_DAILY = 1;
    private final double ABNORMAL_RECON_TOOL_GROUP_B_PROBABILITY_ADMIN_USER = 0.0004; // ~1440 events per hour
    ...
    private final double ABNORMAL_RECON_TOOL_GROUP_B_PROBABILITY_SERVICE_ACCOUNT_USER = 0; // Not relevant to service accounts
