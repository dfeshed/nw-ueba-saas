...
import presidio.data.generators.event.performance.scenario.RegistryPerformanceStabilityScenario;
...
public class RegistryPerformanceStabilityTest {
    ...
    public void test() throws GeneratorException {
        ...
        RegistryPerformanceStabilityScenario scenario = new RegistryPerformanceStabilityScenario(startInstant, endInstant,1000, 50, 50, 1);
        scenario.init();
