...
module('Unit | Reducers | Policy Wizard Reducers', function() {
  ...
  test('on FETCH_POLICY success, availableSettings & selectedSettings are properly set', function(assert) {
    ...
    assert.equal(endState.availableSettings[8].isEnabled, false, 'isEnabled flag is correctly set for the component agentMode');
    assert.equal(endState.availableSettings[20].isEnabled, false, 'isEnabled is correctly set for rar');
