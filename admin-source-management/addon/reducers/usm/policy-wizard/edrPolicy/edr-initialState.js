...
export default {
  ...
  availableSettings: [
    ...
    { index: 3, id: 'recurrenceInterval', label: 'adminUsm.policyWizard.edrPolicy.recurrenceInterval', isEnabled: true, isGreyedOut: true, parentId: 'scanType', component: 'usm-policies/policy-wizard/policy-types/edr/recurrence-interval', defaults: [{ field: 'recurrenceInterval', value: 1 }, { field: 'recurrenceUnit', value: 'WEEKS' }] },
