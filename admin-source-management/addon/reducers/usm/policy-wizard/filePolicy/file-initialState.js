...
export default {
  ...
  availableSettings: [
    ...
    { index: 5, id: 'protocol', label: 'adminUsm.policyWizard.filePolicy.protocol', isEnabled: true, isGreyedOut: false, headerId: 'fileSettingsHeader', parentId: null, component: 'usm-policies/policy-wizard/policy-types/windows-log/windows-log-protocol', defaults: [{ field: 'protocol', value: 'TLS' }] },
