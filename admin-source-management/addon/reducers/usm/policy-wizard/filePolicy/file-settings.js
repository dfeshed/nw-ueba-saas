...
export const SOURCE_CONFIG = [
  ...
  { field: 'paths', title: 'adminUsm.policyWizard.filePolicy.logFilePath', width: '97%', displayType: 'paths', component: 'usm-policies/policy-wizard/define-policy-sources-step/body-cell' },
  ...
  { field: 'advancedSettingsCell', title: 'adminUsm.policyWizard.filePolicy.advancedSettings', width: '30vw', displayType: 'advancedSettingsCell', component: 'usm-policies/policy-wizard/define-policy-sources-step/advanced-settings-cell',
    config: [
