...
export default {
  ...
  availableSettings: [
    ...
    { index: 6, id: 'channelFilters', label: 'adminUsm.policyWizard.windowsLogPolicy.channelFilters', isEnabled: true, isGreyedOut: false, headerId: 'windowsLogSettingsHeader', parentId: null, component: 'usm-policies/policy-wizard/policy-types/windows-log/windows-log-channel-filters', defaults: [{ field: 'channelFilters', value: [{ channel: '', filterType: 'INCLUDE', eventId: 'ALL' }] }] }
