...
export default Route.extend({
  ...
  model() {
    return {
      'title': 'Form Textarea (one-way binding)',
      ...
      'jsRepo': 'https://github.rsa.lab.emc.com/asoc/sa-ui/blob/master/component-lib/addon/components/rsa-form-textarea-oneway.js',
      ...
      'templateRepo': 'https://github.rsa.lab.emc.com/asoc/sa-ui/blob/master/component-lib/addon/templates/components/rsa-form-textarea-oneway.hbs'
    };
  }
