...
test('it includes the proper classes', function(assert) {
  ...
  const badgeCount = this.$().find('.rsa-content-badge-score').length;
...
test('it sets the score', function(assert) {
  ...
  const label = this.$().find('.score').text();
...
test('it includes the proper classes when there is no label', function(assert) {
  ...
  const badge = this.$().find('.rsa-content-badge-score').first();
...
test('it includes the proper classes when isInline is true', function(assert) {
  ...
  const progressBar = this.$().find('.progress-bar').first();
