...
public class AlertsDataScenarioNoSpring extends DataPreparationBaseNoSping {
    private static Logger LOGGER = (Logger) LoggerFactory.getLogger(AlertsDataScenarioNoSpring.class);
