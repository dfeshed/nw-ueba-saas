...
import { patchFetch } from 'netwitness-ueba/tests/helpers/patch-fetch';
        ...
        resolve({
          ...
          text() {
            return new Promise(function(r) {
              r("define('netwitness-ueba/locales/es-mx/translations', ['exports'], function (exports) { exports.default = { title: 'spanish_x' }; })");
            });
          }
        });
      });
